...
<table id="simpletable_D04D41FBB03D4992B257CCBAD7EF0E7B"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>返回的内容 <span class="codeph"> 晕影：:UserData </span>. </p> </td> 
 </tr> 
</table>

除非在详细描述中另有说明，否则服务器会返回MIME类型的文本响应 &lt;text plain=&quot;&quot;>.
...
返回在URL路径中指定的晕影文件或目录条目的选定属性。 请参阅 [属性](../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-response-data/c-ir-properties.md#concept-e99f1a373eae4af9b41842ca0088ad3a) 有关回复语法和响应MIME类型的描述。 请求中的其他命令将被忽略。 返回以下属性：
...
<table id="table_A30296D29B5D43F1B5383A887252C6B4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p> <span class="codeph"> 属性：:Expiration </span> 或默认的生存时间。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>字符串型 </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> 属性：:Modifier </span> 或空（如果不是目录条目）。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>字符串型 </p> </td> 
   <td colname="col3"> <p>修改日期/时间(从 <span class="codeph"> catalog::TimeStamp </span> 或晕影文件)。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>真 </p> </td> 
   <td colname="col3"> <p>最大对象分辨率（在中） <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-vignettes/c-ir-material-resolution.md#concept-f60103c64e324e2cae78bd76dfb4de8b" type="concept" format="dita" scope="local"> 材料分辨率 </a> 单位（通常为像素/英寸）。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> vignette.res.avg </span> </p> </td> 
   <td colname="col2"> <p>真 </p> </td> 
   <td colname="col3"> <p>中的平均对象分辨率 <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-vignettes/c-ir-material-resolution.md#concept-f60103c64e324e2cae78bd76dfb4de8b" type="concept" format="dita" scope="local"> 材料分辨率 </a> 单位(通常为像素/inc <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-vignettes/c-ir-material-resolution.md#concept-f60103c64e324e2cae78bd76dfb4de8b" type="concept" format="dita" scope="local"> 材料分辨率 </a>h)。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> vignette.res.min </span> </p> </td> 
   <td colname="col2"> <p>真 </p> </td> 
   <td colname="col3"> <p>中的最小对象分辨率 <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-syntax-and-features/c-ir-vignettes/c-ir-material-resolution.md#concept-f60103c64e324e2cae78bd76dfb4de8b" type="concept" format="dita" scope="local"> 材料分辨率 </a> 单位（通常为像素/英寸）。 </p> </td> 
  </tr> 
  <tr> 
...
地图数据不会缩放到 `wid=` 或 `hei=` 或进行其他修改。 响应MIME类型为 `<text/xml>`.

响应数据由 `<map>` 包含 `<area>` 元素，与HTML类似 `<AREA>` 标记。

每个 `<area>` 元素包括标准 `type=` 和 `coord=` 属性和 `name=` 属性，指定晕影组名称或名称路径。 多个 `<area>` 如果相应对象组的掩码具有不连续区域，则存在具有相同名称的元素。

除了默认属性之外，如果创作了小角色，还可以定义其他属性。 此类自定义属性被定义为对象组属性。 自定义属性的名称必须以开头 `map` 要包含在 `<area>` 元素。 例如，如果群组属性包含 `map.href=http://www.scene7.com`，对应 `<area>` 元素包括 `href="http://www.scene7.com"`.

空的XML文档 `<map>` 元素。

`object`

执行指定命令并返回由剩余对象选择（最后选择的组或对象）掩盖的渲染图像 `sel=` 或 `obj=` 命令)。 通常与支持Alpha的图像格式一起使用(请参阅 [fmt=](../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-fmt.md#reference-4c743f67d56b47c5b774fcc900ff758c))。 如果使用不支持Alpha的图像格式，则蒙版外的区域为黑色。

`props`

执行指定的命令并返回晕影属性和组或对象属性，而不是呈现的图像。 请参阅 [属性](../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-response-data/c-ir-properties.md#concept-e99f1a373eae4af9b41842ca0088ad3a) 有关回复语法和响应MIME类型的描述。 默认选择适用，除非 `obj=` 或 `sel=` (请参阅 [ `obj=` ](../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-obj.md#reference-31e7dac7931b4e0eb3c7589f120a1e6a))。
...
<table id="table_F3ECF0584F6247A2A75C1CAFE1C57A4E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 布尔值 </p> </td> 
   <td> <p>如果ICC配置文件嵌入在回复图像中，则为True(请参阅 <span class="codeph"> <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-iccembed.md#reference-47a433138c7c4b29b9b29871b2491a7f" type="reference" format="dita" scope="local"> iccEmbed= </a> </span>)。 </p> </td> 
  </tr> 
  <tr> 
...
返回的内容 `vignette::UserData`. 服务器将替换 `'??'` in `vignette::UserData` 使用行终结器( `<cr><lf>`)。 回复的格式为文本数据，其响应MIME类型设置为 &lt;text plain=&quot;&quot;>.

如果URL路径中指定的对象未解析为有效的晕影图条目，或者如果 `vignette::UserData` 为空，则回复将仅包含行终结器( `CR/LF`)。
