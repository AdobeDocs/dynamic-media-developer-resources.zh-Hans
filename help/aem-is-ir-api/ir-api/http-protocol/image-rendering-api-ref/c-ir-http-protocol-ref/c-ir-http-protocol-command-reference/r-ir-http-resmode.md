...
重新取样模式。 选择重新取样和/或插值算法，以将渲染的图像缩放到使用wid=、hei=或scl=指定的大小。
...
<table id="table_AF954C101B30473FAFE9930C7B694305"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>选择双立方插值。 与双线性插值相比，CPU密集度更高，但会产生较锐利的图像，出现的锯齿伪像较少。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="+ topic/ph pr-d/codeph codeph"> sharp2  </span> </p> </td> 
   <td colname="col2"> <p>选择修改的Lanczos窗口函数作为插值算法。 在CPU成本较高的情况下，可能会产生比双立方算法更锐利的结果。 </p> <p> <span class="codeph"> sharp已 </span> 被sharp2替 <span class="codeph"> 代， </span>它导致锯齿伪像（也称为Moiré）的可能性较小。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 比沙尔  </span> </p> </td> 
   <td colname="col2"> <p>选择<span class="keyword"> Adobe Photoshop </span>默认重采样器以减小图像大小，在<span class="keyword"> Adobe Photoshop </span>中，该图像大小称为“双立方锐化”。 </p> </td> 
  </tr> 
 </tbody> 
</table>
