...
晕影创作工具(Dynamic Media图像创作包的一部分)提供了控制晕影渲染引擎低级别方面的机制。
...
<table id="table_1517FC39C7344EBB9F17BE20415DB057"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>“渲染效果”/“替代着色器”覆盖晕影中的设置。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>USM（UN锐化）。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p>默认值为on（空），且取消选择= F100G0。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
...
<table id="table_062DCF66ACCC4A6997E3CA951C0A12B8"> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> <p>设置组合 </p> </th> 
   <th colname="col2" class="entry"> <p>说明 </p> </th> 
  </tr>
 </thead>
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>使用锐化的替代着色器： </p> <p> 
     <ul id="ul_93AD53BB37EA47F6A3CEE424D3AAE18C"> 
      ...
      <li id="li_EB0D25C095FB4D5798AC031AB759849B">饱和度调整（中间的第一个顶点、沿边的第二个顶点、第三个顶点中点低） </li> 
      <li id="li_5C2304DA4A4D4799AE5DCCCB1E2ECBB3">锐化（右侧按3/4的方式） </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
