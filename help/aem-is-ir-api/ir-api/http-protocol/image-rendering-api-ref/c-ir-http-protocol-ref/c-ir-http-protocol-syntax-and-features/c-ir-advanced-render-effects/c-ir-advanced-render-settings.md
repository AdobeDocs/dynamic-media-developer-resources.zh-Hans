---
description: 暗角创作工具（Scene7图像创作包的一部分）提供了控制暗角渲染引擎低级别的机制。
seo-description: 暗角创作工具（Scene7图像创作包的一部分）提供了控制暗角渲染引擎低级别的机制。
seo-title: 高级渲染设置
...
暗角创作工具（Scene7图像创作包的一部分）提供了控制暗角渲染引擎低级别的机制。

>[!NOTE]
>
>“渲染设置”是“图像渲染”和“图像创作”的高级功能。 在使用“渲染设置”时，请与Adobe技术支持或Adobe咨询代表联系以获取培训、咨询或两者。

这些设置在图像创作中以交互方式进行控制。 可以使用命令（或使用值）在图像渲染中应 `rs=` 用相同的 `catalog::RenderSettings` 设置。 此机制用于为每个材料选择不同的锐化选项，并修改照明渲染算法的行为，如改变高光的饱和度或阴影中的对比度。
...
<table id="table_1517FC39C7344EBB9F17BE20415DB057"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>“渲染效果”/“替代着色器”将覆盖暗角中的设置。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>USMradius（像素）。 </p> </td> 
   <td colname="col3"> <p>1 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>超采样：随机率。 </p> </td> 
   <td colname="col3"> <p>1 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>用于亮材料的阴影。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>图像创作中的默认值。 
     <ul id="ul_AA7CF1A3E6984B318265BBE8FFFBB4EE">
      ...
      <li id="li_F760B65E057146A7B56673D6B1A9A304">I30 =亮点(0-100)。 </li> 
      <li id="li_376C275FDB3548958C09BD266C77318F">J10 =高光饱和度(0-50)。 </li> 
      <li id="li_FE26429972F544869CDFE2DD61F39CC5">K200 =阴影饱和度(0-400)。 </li> 
      <li id="li_FB6BAA708427428AA4A3AC2E5D3B9932">L400 =光面外推强度(100-600)。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_C6E6DD90ECAB4D2B9284A25A29923DC6"> 
      ...
      <li id="li_A003B68023424DCABBF3A2CAF98C39A4">所有最大值和亮度补偿均开启。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>具有锐化的替代着色器： </p> <p> 
     <ul id="ul_93AD53BB37EA47F6A3CEE424D3AAE18C"> 
      ...
      <li id="li_E5ED76998C0543D8A3F9AD178CFD3C2C">重新取样（超像素取样，随机为半，速率为半） </li> 
      <li id="li_CCEE53544E7D48858398BF3168F1E87D">对比度（更强） </li> 
      <li id="li_EB0D25C095FB4D5798AC031AB759849B">饱和度调整（沿边的中间、第二个顶点中的第一个顶点、第三个顶点中间点低） </li> 
