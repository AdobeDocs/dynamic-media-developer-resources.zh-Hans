---
title: 進階演算設定
description: 暈映製作工具(Dynamic Media Image Authoring套件的一部分)提供機制來控制暈映轉譯引擎的低階方面。
...
暈映製作工具(Dynamic Media Image Authoring套件的一部分)提供機制來控制暈映轉譯引擎的低階方面。

>[!NOTE]
>
>「演算設定」是「影像演算」和「影像製作」的進階功能。 請聯絡Adobe技術支援或您的Adobe諮詢代表，以取得有關使用轉譯器設定的訓練、諮詢或兩者。

這些設定是在「影像製作」中以互動方式控制。 您可以使用以下專案在影像演算中套用相同的設定 `rs=` 命令(或使用 `catalog::RenderSettings` 值)。 此機制可用來為每個材料選取不同的銳利化選項，並修改照明彩現演演算法的行為，例如改變亮部的飽和度或陰影的對比。
...
<table id="table_1517FC39C7344EBB9F17BE20415DB057"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>USM （不銳利化）。 </p> </td> 
   <td colname="col3"> <p>0 </p> </td> 
   <td colname="col4"> <p>2 </p> </td> 
   <td colname="col5"> <p>若要使用USM，U必須大於0 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>usm半徑（畫素）。 </p> </td> 
   <td colname="col3"> <p>1 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p> 
     <ul id="ul_FD4A9D73C32F47C3BF13776BB4D2818D"> 
      ...
      <li id="li_6E9D81045A0C4804A4D35D9B239F6486">Poisson取樣器 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>最適化調整大小：深度。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>調適型調整大小：寬度。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>明亮材料的陰影。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col5"> <p>預設為開啟（空白）且取消選取= F100G0。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>影像製作中的預設值。 
     <ul id="ul_AA7CF1A3E6984B318265BBE8FFFBB4EE">
      ...
      <li id="li_376C275FDB3548958C09BD266C77318F">J10 =醒目提示飽和度(0-50)。 </li> 
      ...
      <li id="li_F39D3834D4A2478D993E5E9C9B434CFE">X0 = USM臨界值（0-255個層級）。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_AAEC098CED1C436E933B1C1B88DFB659"> 
      ...
      <li id="li_E36886FB1D00444CBA19D7245E89B292">所有最大值和亮度補償皆關閉。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_6BB668C6C055493DAAA38F4D3B9C20A7"> 
      ...
      <li id="li_DA685F4DE4BA427BA7BE241A75C96152">所有最大值和亮度補償皆關閉。 </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>使用銳利化的替代著色器： </p> <p> 
     <ul id="ul_93AD53BB37EA47F6A3CEE424D3AAE18C"> 
      ...
      <li id="li_EB0D25C095FB4D5798AC031AB759849B">飽和度調整（第一個頂點在中間，第二個頂點沿著邊，第三個頂點中點低） </li> 
