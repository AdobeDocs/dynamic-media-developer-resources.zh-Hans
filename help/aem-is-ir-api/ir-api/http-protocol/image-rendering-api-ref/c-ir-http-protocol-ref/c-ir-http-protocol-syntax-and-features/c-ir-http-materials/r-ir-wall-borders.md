---
description: 当材料在壁边界MSS（子=3..5引入）中指定时，它被视为壁边界。
seo-description: 当材料在壁边界MSS（子=3..5引入）中指定时，它被视为壁边界。
seo-title: 墙边框
...
当材料在壁边界MSS（子=3..5引入）中指定时，它被视为壁边界。

壁边纹理图像可以包括用于定义边框形状的alpha渠道。 墙边框只能应用于墙对象。
