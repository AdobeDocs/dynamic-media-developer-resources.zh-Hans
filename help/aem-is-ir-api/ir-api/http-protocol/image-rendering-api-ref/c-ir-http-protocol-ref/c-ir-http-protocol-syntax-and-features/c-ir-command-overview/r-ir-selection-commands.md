...
命令或材料或两者都在此选择命令之后以及下一个选择命令（或请求结束）应用到所选项之前指定。 选择命令可分隔材料规范段(MSS)。
...
<table id="simpletable_028957E516644FE8A7B1BC056A32FCD1"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-decal.md#reference-3a5f1adc7fe24c91aa5655d64038e857" type="reference" format="dita" scope="local"> 十</a></span> </p></td> 
