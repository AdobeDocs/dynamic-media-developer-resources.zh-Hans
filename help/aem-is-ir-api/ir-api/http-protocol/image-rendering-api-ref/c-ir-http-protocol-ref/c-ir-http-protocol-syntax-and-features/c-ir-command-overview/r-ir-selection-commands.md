...
命令或材料，或者两者，在此选择命令之后和在将下一个选择命令（或请求的结尾）应用到选定项之前指定。 选择命令可分隔材料规范段(MSS)。
...
<table id="simpletable_028957E516644FE8A7B1BC056A32FCD1"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-decal.md#reference-3a5f1adc7fe24c91aa5655d64038e857" type="reference" format="dita" scope="local"> 倾斜</a></span> </p></td> 
  <td class="stentry"> <p>选择所选对象的贴图区域。 </p></td> 
 </tr> 
 <tr class="strow"> 
