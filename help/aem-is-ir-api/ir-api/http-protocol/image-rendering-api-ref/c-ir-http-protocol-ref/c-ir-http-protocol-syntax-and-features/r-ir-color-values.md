---
title: 颜色值
description: color=和bgc=属性的color值可以使用小数、逗号分隔的组件值列表或十六进制表示法指定，类似于HTML。
...
颜色值 `color=` 和 `bgc=` 属性可以使用小数、逗号分隔的组件值列表或十六进制表示法来指定，类似于HTML。
...
<table id="simpletable_9B3A231D5BB14A3DB2B42B341E198341"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p><i>红，绿，蓝，灰</i> </p></td> 
  <td class="stentry"> <p>颜色组件值（0至255，十进制整数）。 </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><i>hex6</i> </p></td> 
  <td class="stentry"> <p>打包了六位数的十六进制RGB颜色值(RRGGBB)。 </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><i>hex2</i> </p></td> 
  <td class="stentry"> <p>压缩了两位数的十六进制灰度值(0...FF)。 </p></td> 
 </tr> 
</table>

## 示例 {#section-a78732151d584e84abeb99f9ce8d7c24}

有效颜色说明符的一些示例及其对应的RGB颜色值解释：
