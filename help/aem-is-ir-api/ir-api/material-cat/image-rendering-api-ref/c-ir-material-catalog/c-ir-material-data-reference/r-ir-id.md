---
description: 目录记录标识符。 Render Server查看材料记录时使用的键值。 通常为短的唯一材料标识符，如SKU编号。
seo-description: 目录记录标识符。 Render Server查看材料记录时使用的键值。 通常为短的唯一材料标识符，如SKU编号。
seo-title: Id
...
目录记录标识符。 Render Server查看材料记录时使用的键值。 通常为短的唯一材料标识符，如SKU编号。
