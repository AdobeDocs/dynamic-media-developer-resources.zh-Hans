...
+ 影像伺服API {#image-serving-api}
   ...
   + [目標對象](is-api/image-serving-api-ref/c-intended-audience.md)
   ...
   + HTTP通訊協定參考 {#http-protocol-reference}
      ...
      + HTTP通訊協定簡介 {#http-protocol-introduction}
         ...
         + [目標對象](is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-introduction/c-intended-audience.md)
