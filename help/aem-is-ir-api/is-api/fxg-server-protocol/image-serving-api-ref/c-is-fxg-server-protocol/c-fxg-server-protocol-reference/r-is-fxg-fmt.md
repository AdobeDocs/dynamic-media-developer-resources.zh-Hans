...
<table id="simpletable_66FAABB7BD7A4BBB815A570BEA4C1AE8"> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> 格 <span class="varname"> 式</span></span> </p></td> 
  <td class="stentry"> <p><span class="codeph"> jpeg| png| png-alpha| tif| tif-alpha| swf| pdf| gif| gif-alpha| fxg| fxgraw</span> </p></td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"></td> 
  <td class="stentry"> <p> 为发送到客户端的图像数据指定图像编码格式，为HTTP回复头指定相应的响应MIME类型。 </p> <p> <span class="codeph">  jpeg </span>:有损JPEG </p> <p> <span class="codeph"> png </span>:无损PNG </p> <p> <span class="codeph"> png-alpha </span>:带有alpha渠道的无损PNG </p> <p> <span class="codeph">  tif </span>:TIFF </p> <p> <span class="codeph"> tif-alpha </span>:带有Alpha渠道的TIFF </p> <p> <span class="codeph">  swf </span>:嵌入到Adobe swf文件中的有损JPEG </p> <p> <span class="codeph"> pdf </span>:嵌入在PDF中的图像 </p> <p> <span class="codeph"> gif </span>:2到256色的GIF </p> <p> <span class="codeph"> gif-alpha </span>:2到255色的GIF加上主色透明度 </p> <p> <span class="codeph"> fxg </span>:应用了变量和DOM操作的FXG </p> <p> <span class="codeph">  fxgraw </span>:存储在服务器上的原始FXG </p> </td> 
 </tr> 
 <tr class="strow"> 
...
`tiffCompression` 仅当将tif-alpha指定为格式时，才允许。 有关这些图像格式支持的压缩选项，请参阅下表。

`qlt=` 可用于为以下格式设置JPEG编码选项：JPEG、TIFF（带JPEG压缩）。 如果fmt=gif或fmt=gif-alpha，则可以使用quantize=。 有关详细信息，请参阅命令说明。 其他格式没有可设置的选项。

对于所有格式和内容，将返回8位／像素组件 `pixelTypes[7]`。

下表列表了格式和相应HTTP响 `pixelType`应MIME类型的有效组合。
...
<table id="table_54AFE58185004C74971EFBA845E177B6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>是 </p> </td> 
   <td> <p><span class="codeph"> <span class="varname"> tiff压缩</span> （无）| lzw| zip| jpeg), qlt=</span> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>&lt;image/gif&gt; </p> </td> 
   <td> <p>无 </p> </td> 
   <td> <p><span class="codeph"> 数量化=</span> </p> </td> 
  </tr> 
 </tbody> 
</table>
