---
description: 响应数据属性。 评估当前请求，就像它是图像请求(req=img)，但服务器不返回图像，而是返回回复图像的选定属性。
...
响应数据属性。 评估当前请求，就像它是图像请求(req=img)，但服务器不返回图像，而是返回回复图像的选定属性。
...
参见 [属性](../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-response-data/c-properties/c-properties.md#concept-49c609fd6de942cab422ee412353c9d9) 有关回复语法和响应MIME类型的说明。 HTTP响应可通过基于以下内容的TTL进行缓存： `attribute::NonImgExpiration`.
...
<table id="table_9665612ED7D24C07AAF75D953C0FEB36"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> boolean </p> </td> 
   <td> <p> 如果ICC配置文件嵌入回复图像中，则为true。 (请参阅 <span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-iccembed.md#reference-e3b774fb322046a2a6dde3a7bab5583e" type="reference" format="dita" scope="local"> IccEmbed= </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> boolean </p> </td> 
   <td> <p> 如果响应图像嵌入了任何路径，则为1，否则为0。 (请参阅 <span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-pathembed.md#reference-9ccf0771d6634cf68c1c9c33cd428301" type="reference" format="dita" scope="local"> pathEmbed= </a> </span>.) </p> </td> 
  </tr> 
  <tr valign="top"> 
...
<table id="table_B66360C475CE495D9701AB526E758873"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 字串 </p> </td> 
   <td> <p> 修改日期/时间(从 <span class="codeph"> 静态：：时间戳 </span> 或对象文件) </p> </td> 
  </tr> 
  <tr> 
