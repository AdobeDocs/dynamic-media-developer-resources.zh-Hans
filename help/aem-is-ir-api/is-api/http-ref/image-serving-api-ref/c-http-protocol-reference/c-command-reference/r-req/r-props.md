---
description: 响应数据属性。 评估当前请求时，就像它是图像请求(req=img)一样，但服务器不会返回图像，而是返回回复图像的选定属性。
...
响应数据属性。 评估当前请求时，就像它是图像请求(req=img)一样，但服务器不会返回图像，而是返回回复图像的选定属性。
...
有关回复语法和响应MIME类型的描述，请参阅[属性](../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-response-data/c-properties/c-properties.md#concept-49c609fd6de942cab422ee412353c9d9)。 HTTP响应可缓存，其TTL基于`attribute::NonImgExpiration`。
...
<table id="table_9665612ED7D24C07AAF75D953C0FEB36"> 
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> 整数 </p> </td> 
   <td> <p> 返回大小（以像素为单位，不包含HTTP标头）；如果服务器之前未缓存回复图像数据，则为0。 （请参阅<span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-req/r-req.md#reference-907cdb4a97034db7ad94695f25552e76" type="reference" format="dita" scope="local"> req=loadcache </a> </span>。） </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> image.mask  </span> </p> </td> 
   <td> <p> 枚举 </p> </td> 
   <td> <p> 1如果回复图像包含alpha通道，则为0。 </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> <span class="codeph"> image.pixTyp  </span> </p> </td> 
   <td> <p> 字串 </p> </td> 
   <td> <p> 回复图像类型，可以是<span class="codeph"> CMYK </span>、<span class="codeph"> RGB </span>或<span class="codeph"> BW </span>（对于灰度图像）。 </p> </td> 
  </tr> 
  <tr valign="top"> 
  ...
  <tr valign="top"> 
   ...
   <td> <p> 布尔 </p> </td> 
   <td> <p> 1如果响应图像嵌入了xmp数据，则为0；否则为0。 （请参阅<span class="codeph"> <a href="../../../../../../is-api/http-ref/image-serving-api-ref/c-http-protocol-reference/c-command-reference/r-xmpembed.md#reference-46ecf40a40a0442fa62de3a85dcb03e8" type="reference" format="dita" scope="local"> xmpEmbed= </a> </span>。） </p> </td> 
  </tr> 
  <tr valign="top"> 
...
<table id="table_B66360C475CE495D9701AB526E758873"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 双 </p> </td> 
   <td> <p> <span class="codeph"> 静态：：过期 </span> 时间或默认的生存时间 </p> </td> 
  </tr> 
  <tr> 
   <td> <p> <span class="codeph"> lastModified  </span> </p> </td> 
   <td> <p> 字串 </p> </td> 
   <td> <p> 修改日期/时间（从<span class="codeph">静态：:TimeStamp </span>或对象文件） </p> </td> 
  </tr> 
  <tr> 
