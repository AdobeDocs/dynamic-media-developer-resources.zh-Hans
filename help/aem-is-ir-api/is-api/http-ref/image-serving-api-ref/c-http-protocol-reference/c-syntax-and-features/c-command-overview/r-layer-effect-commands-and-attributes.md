...
这些命令可用于定义图层效果，如投影或发光效果。 效果图层会忽略所有其他命令。
...
<table id="simpletable_3094B9783772437FAACF9B382F7A32EE"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>开始效果图层段并指定z顺序。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>指定如何使用父项的图层蒙版(Alpha渠道)。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>增大或收缩图层效果。 </p></td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>为效果添加杂色。 </p></td> 
 </tr> 
 <tr class="strow"> 
