---
description: 这些命令适用于图像、文本和纯色层。 对于复合图像和简单的非分层请求而言，大多数都没有意义。 它们不适用于效果图层。
...
# 公共层命令{#common-layer-commands}

这些命令适用于图像、文本和纯色层。 对于复合图像和简单的非分层请求而言，大多数都没有意义。 它们不适用于效果图层。
...
<table id="simpletable_8A74E965537D4E8CB91E95AEAE9673E0"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>扩展（或裁剪）层矩形。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>为此图层定义图像映射。 </p></td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>指定层大小约束。 </p></td> 
 </tr> 
 <tr class="strow"> 
