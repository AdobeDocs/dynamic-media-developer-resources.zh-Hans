---
description: 以下示例展示了文本命令的示例及其对文本的影响。
seo-description: 以下示例展示了文本命令的示例及其对文本的影响。
seo-title: RTF编码示例
