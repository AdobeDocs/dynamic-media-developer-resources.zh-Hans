...
<table id="simpletable_9EBE66066E854ABE978F8F7ADC66BDE3"> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p> <span class="codeph">{{<span class="varname"> gray</span>[,<span class="varname"> alpha</span>][g]}|</span> </p> <p> <span class="codeph"> {<span class="varname"> red</span>,<span class="varname"> green</span><span class="varname"> ,</span>blue<span class="varname"> [,</span>rgbAlphaAlpha][r]}|</span> </p> <p> <span class="codeph"> {<span class="varname"> 青</span>、洋 <span class="varname"> 红</span> <span class="varname"> 、</span>黄色 <span class="varname"> 、</span>黑色[,alpha]k}|</span> </p> <p> <span class="codeph"> {0x{hex2|hex4}[g]}|</span> </p> <p> <span class="codeph">{[0x]{<span class="varname"> hex6</span>|<span class="varname"> hex8</span>}[r]}|</span> </p> <p> <span class="codeph"> {[0x]{<span class="varname"> hex8</span>|<span class="varname"> hex10</span>}k}[s]</span> </p> </td> 
 </tr> 
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>颜色分量值(0...255, decimal int) </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p><span class="codeph"> <span class="varname"> 青</span>色、 <span class="varname"> 洋红</span>、黄 <span class="varname"> 色</span>、黑 <span class="varname"> 色</span>、 <span class="varname"> alpha</span></span> </p></td> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>灰色分量值（0...100%，十进制整数） </p> </td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>带有alpha值的10位十六进制CMYK(CCYYMMKKAA) </p> </td> 
 </tr> 
</table>
...
“s”后缀指定颜色值与与颜色值的像素类型（由`attribute::IccProfileSrc*`定义）对应的输入（源）色彩空间相关联。 如果此后缀不存在，则颜色值与输出（目标）色彩空间（用`icc=`或`attribute::IccProfile*`定义）相关联。

## 默认 {#section-737082a7da544acca8092a48d88480e7}

如果未显式指定alpha值，则假定它为255、0xFF或100%（完全不透明）。
