...
## 5.13.1 {#section-f55c5ff7f6d0406c8739de4981dd7195}的新增功能和增强功能

* 添加了与Adobe Launch Dynamic Media查看器扩展集成的支持。
* 增加了对Oculus Browser for Video360Viewer中VR操作模式的支持。
* 添加了`RolloverKeyEvent.HREF_ACTIVATED`事件，以允许客户端代码响应eCatalogViewer和eCatalogSearchViewer中的图像映射激活。

## 5.13.1 {#section-50e7ea1e01dd4e1fa9c8b3e00eb002b4}的错误修复
