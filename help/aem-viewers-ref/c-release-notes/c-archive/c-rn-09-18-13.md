...
* 新的IE安全修补程序要求用户在IE中激活Flash和其他ActiveX®应用程序。 有关变通方案的信息，请参阅®网站。
...
* 当查看器嵌入到HTTPS页面中时生成异常错误。 问题是由与服务器日志记录通信引起的。 有关详细信息[https://www.adobe.com/cn/products/flashplayer/end-of-life.html](https://www.adobe.com/cn/products/flashplayer/end-of-life.html)。
