---
title: Dynamic Media Viewers发行说明(5.12.1)
description: Dynamic Media Viewers发行说明(5.12.1)
...
## 5.12.1的新增功能和增强功能 {#section-f55c5ff7f6d0406c8739de4981dd7195}
...
* IS命令中的图像服务修饰符未添加到 `req=set` 设计要求。 但是，只影响图像显示的修饰符可以正常使用。 必须在复杂资源中使用影响大小的修饰符。 例如：
...
* 在iPad或Android™设备上，加载查看器时，屏幕上可能会闪烁“黑框”。
