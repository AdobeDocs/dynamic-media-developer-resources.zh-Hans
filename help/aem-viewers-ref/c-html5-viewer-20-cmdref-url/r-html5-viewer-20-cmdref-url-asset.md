...
此属性是必需的，除非 `video` 参数。 参见 [外部视频支持](../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-external-video-support.md#concept-22c67fee43274a29b28ee16770b1b1f3) 在视频下或 [外部视频支持](../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-external-video-support.md#concept-66aa2784f2294794989bad2af74c3760) 在Video360下。
...
` asset= *`图像`* | *`imageList`* | *`imageListWithModifiers`* | *`multiDimensionsSpinSet`* [%3F *`修饰符`*]`

<table id="table_A2A0ACD942E942BC99AF0DC80FB1C670"> 
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> 图像 </span> </span> </p> </td> 
   <td colname="col2"> <p> 指定单个图像。 将双重HTTP编码应用于映像名称中存在的任何不安全字符。 </p> <p>或者，指定对图像集的引用。 查看器使用从服务器检索图像集 <span class="codeph"> req=set IS </span> 请求。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> imageList </span> </span> </p> </td> 
   <td colname="col2"> <p> 指定显式图像集，它由以逗号分隔的已排序项目或帧序列组成。 </p> <p> <p>注意：Adobe Dynamic Media Classic支持此功能；Adobe Experience Manager Assets不支持此功能。 </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> imageListWithModifiers </span> </span> </p> </td> 
   <td colname="col2"> <p> 指定每个帧都有其自己的图像服务修饰符的显式图像集。 在这种情况下，框架列表将括在括号中。 确保将双HTTP编码应用于特定于帧的图像服务修饰符中存在的任意逗号。 </p> <p> <p>注意：Adobe Dynamic Media Classic支持此功能；Adobe Experience Manager Assets不支持此功能。 </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> multiDimensionsSpinSet </span> </span> </p> </td> 
   <td colname="col2"> <p>使用以下语法指定显式多维旋转集： </p> <p> <span class="codeph"> (( <span class="varname"> horizontalspinset </span>)[，( <span class="varname"> horizontalspinset </span>)]) </span> </p> <p> 位置 <span class="codeph"> <span class="varname"> horizontalspinset </span> </span> 是给定水平轴的逗号分隔框架列表。 全部 <span class="codeph"> <span class="varname"> horizontalspinset </span> </span> 应具有相同的帧数。 </p> <p> <p>注意：Adobe Dynamic Media Classic支持此功能；Adobe Experience Manager Assets不支持此功能。 </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> 修饰符 </span> </span> </p> </td> 
   <td colname="col2"> <p> 图像服务命令； <span class="codeph"> 和 </span> 和 <span class="codeph"> = </span> 分隔符必须为HTTP编码 <span class="codeph"> %26 </span> 和 <span class="codeph"> %3D </span>，则不会显示任何内容。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
` asset=( *`mediaSet`* | ( *`视频`*; *`样本ID`* | *`图像`*; *`样本ID`* | *`setId`*; *`样本ID`*); *`ID`*;( *`视频`*; *`样本ID`* | *`图像`*; *`样本ID`* | *`setId`*; *`样本ID`*); *`ID`*;] [%3F *`修饰符`*]`
...
<table id="table_D31C8507C02A4452A79DEDDEC62EF2F5"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 单个视频或自适应视频集。 </p> <p> <p>注意：Adobe Dynamic Media Classic支持此功能；Adobe Experience Manager Assets不支持此功能。 </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> 图像 </span> </span> </p> </td> 
   <td colname="col2"> <p> 单个图像。 </p> <p> <p>注意：Adobe Dynamic Media Classic支持此功能；Adobe Experience Manager Assets不支持此功能。 </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> setId </span> </span> </p> </td> 
   <td colname="col2"> <p> 样本集。 </p> <p> <p>注意：Adobe Dynamic Media Classic支持此功能；Adobe Experience Manager Assets不支持此功能。 </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> 样本ID </span> </span> </p> </td> 
   <td colname="col2"> <p>样本图像。 </p> <p> <p>注意：Adobe Dynamic Media Classic支持此功能；Adobe Experience Manager Assets不支持此功能。 </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> ID </span> </span> </p> </td> 
   <td colname="col2"> <p> 媒体集项目类型标识符可以是以下项之一： </p> <p> 
     <ul id="ul_3100F9356628498DA820C07F6F69CC9B"> 
      <li id="li_51B649A539F14510873CFDA85A6AA714"> <p> <span class="codeph"> advanced_image </span> </p> <p>对于单个图像。 </p> </li> 
     ...
     </ul> </p> <p> <p>注意：Adobe Dynamic Media Classic支持此功能；Adobe Experience Manager Assets不支持此功能。 </p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> 修饰符 </span> </span> </p> </td> 
   <td colname="col2"> <p> 图像服务命令； <span class="codeph"> 和 </span> 和 <span class="codeph"> = </span> 分隔符必须为HTTP编码 <span class="codeph"> %26 </span> 和 <span class="codeph"> %3D </span>，则不会显示任何内容。 </p> </td> 
