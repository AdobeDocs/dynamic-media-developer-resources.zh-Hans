...
<table id="table_9B98C97485DD4DEB8A6ECBCE8DF6B886"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 指定默认题注状态。 启用为 <span class="codeph"> 1 </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E752D7D8C1AA40C6B8A7057D2BB379C1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p> 注解文本开头插入VideoPlayer组件的百分比。 </p> <p>默认为 <span class="codeph"> 0% </span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> S </span> </p> </td> 
   <td colname="col2"> <p>行大小 </p> </td> 
   <td colname="col3"> <p> 0%-100% </p> </td> 
   <td colname="col4"> <p> 用于字幕的视频宽度的百分比。 </p> <p>默认为 <span class="codeph"> 100% </span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> L </span> </p> </td> 
   <td colname="col2"> <p>行位置 </p> </td> 
   <td colname="col3"> <p> 0%-100%|整数 </p> </td> 
   <td colname="col4"> <p> 确定页面上的行位置。 </p> <p>如果以不带百分比符号的整数形式表示，则为顶部显示文本的行数。 </p> <p>如果以百分比表示 — 百分比符号是最后一个字符 — 则说明文本在显示区域以百分比形式显示。 </p> <p>默认为 <span class="codeph"> 100% </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_CB7B4DFC6B654AECA1AF6594E3FD5C46"> 
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> <span class="varname"> 文件 </span> </span> </p> </td> 
   <td colname="col2"> <p> 指定WebVTT描述内容的URL或路径。 WebVTT文件由图像服务提供服务。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 0 | 1 </span> </p> </td> 
   <td colname="col2"> <p> 指定默认题注状态。 </p> <p>启用为 <span class="codeph"> 1 </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
