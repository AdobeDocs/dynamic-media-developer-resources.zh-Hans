...
description: Flyout Viewer的主类是FlyoutViewer。 它在s7viewers命名空间中声明。 此JavaScript API涵盖此特定类的构造函数、方法和回调。
...
# 弹出查看器的JavaScript API参考{#javascript-api-reference-for-flyout-viewer}

Flyout Viewer的主类是FlyoutViewer。 它在s7viewers命名空间中声明。 此JavaScript API涵盖此特定类的构造函数、方法和回调。
...
* [弹出查看器](r-html5-flyout-viewer-20-javascriptapiref-.flyoutviewer.md)
