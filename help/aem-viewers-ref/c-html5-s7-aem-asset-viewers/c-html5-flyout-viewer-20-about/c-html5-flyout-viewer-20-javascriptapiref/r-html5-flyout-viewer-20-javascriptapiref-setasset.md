...
<table id="table_896DFF34A68A403DB93A6D597461A573"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>{<span class="codeph"> String</span>}新资产ID、显式图像集或显式图像集（带有帧特定图像服务修饰符），后面附加可选的全局图像服务修饰符 <span class="codeph"> ?</span> </p> <p> 此查看器不支持使用IR（图像渲染）或UGC（用户生成的内容）的图像。 </p> </td> 
  </tr> 
 </tbody> 
</table>
