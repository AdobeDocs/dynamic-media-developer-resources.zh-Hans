---
description: 基本缩放查看器支持Adobe Analytics开箱跟踪。
seo-description: 基本缩放查看器支持Adobe Analytics开箱跟踪。
...
基本缩放查看器支持Adobe Analytics开箱跟踪。

## 现成跟踪{#section-ba994f079d0343c8ae48adffaa3195a3}

基本缩放查看器支持[!DNL Adobe Analytics]开箱即用跟踪。 要启用跟踪，请将正确的公司预设名称作为`config2`参数进行传递。
