---
title: “关闭”按钮
description: 选择此按钮将关闭包含的网页。 仅当closebutton参数设置为1时，才会显示此按钮。 您可以使用CSS调整此按钮的大小、外观和位置。
...
单击或点按此按钮可关闭包含的网页。 仅当closebutton参数设置为1时，才会显示此按钮。 您可以使用CSS调整此按钮的大小、外观和位置。
...
可对按钮工具提示进行本地化。 参见 [用户界面元素的本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-20-basic-zoom-viewer-about/c-html5-20-basic-zoom-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) 了解更多信息。

示例 — 设置一个32 x 32像素的“关闭”按钮，该按钮位于距离查看器上边缘和右边缘六个像素的位置。 它必须为四种不同的按钮状态中的每一种显示不同的图像。
