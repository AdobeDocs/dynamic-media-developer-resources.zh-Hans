---
description: 主视图区域是缩放图像所占用的区域。 通常，当未指定大小时，它会设置为适合可用的设备屏幕。
seo-description: 主视图区域是缩放图像所占用的区域。 通常，当未指定大小时，它会设置为适合可用的设备屏幕。
seo-title: 主查看器区域
...
主视图区域是缩放图像所占用的区域。 通常，当未指定大小时，它会设置为适合可用的设备屏幕。
