...
单击或点按此按钮会重置主视图中的图像。 此按钮显示在台式机系统和平板电脑的主控制栏中。 在手机上，此按钮显示在图像的底部中心。 但是，当图像处于重置状态时，不会显示该图像。 您可以使用CSS调整此按钮的大小、外观和位置。
...
<table id="table_94EE3F5BBE4547C0B4943471CEE7EDE4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>从主控件栏（在台式机和平板电脑上）或查看器（在手机上）的上边框进行定位，包括边距。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 右 </span> </p> </td> 
   <td colname="col2"> <p>从主控制栏（在台式机和平板电脑上）或查看器（在手机上）的右边框中定位，包括边距。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>从主控件栏（在台式机和平板电脑上）或查看器（在手机上）的底部边框进行定位，包括边距。 </p> </td> 
  </tr> 
  <tr> 
...
示例 — 设置一个28 x 28像素的缩放重置按钮，该按钮位于（桌面上）距主控件条底部4像素，距右边47像素，并针对四个不同按钮状态中的每个状态显示不同的图像。
