---
title: 缩小按钮
description: 选择此按钮可缩小主视图中的图像。 为了节省屏幕空间，此按钮不显示在手机上。 您可以使用CSS调整此按钮的大小、外观和位置。
...
选择此按钮可缩小主视图中的图像。 为了节省屏幕空间，此按钮不显示在手机上。 您可以使用CSS调整此按钮的大小、外观和位置。
...
示例 — 设置一个28 x 28像素的缩小按钮，该按钮从底部放置4像素，从主控件栏的右边缘放置75像素。 最后，为四种不同的按钮状态分别显示不同的图像。
