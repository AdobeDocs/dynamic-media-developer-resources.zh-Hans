---
title: “大上一页”按钮
description: 选择此按钮可将用户转到目录中的上一页。 此按钮显示在主控制栏中。 此按钮不显示在手机上以节省屏幕资产。 您可以使用CSS调整按钮的大小、外观和位置。
...
选择此按钮可将用户转到目录中的上一页。 此按钮显示在主控制栏中。 此按钮不显示在手机上以节省屏幕资产。 您可以使用CSS调整按钮的大小、外观和位置。
