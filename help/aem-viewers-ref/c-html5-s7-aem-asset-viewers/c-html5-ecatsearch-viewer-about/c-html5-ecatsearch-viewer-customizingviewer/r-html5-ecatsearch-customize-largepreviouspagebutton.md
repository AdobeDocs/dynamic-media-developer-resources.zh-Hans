---
title: 上一頁大按鈕
description: 選取此按鈕會將使用者導向到目錄中的上一頁。 此按鈕會出現在主控制列中。 此按鈕不會顯示在行動電話上，以節省熒幕空間。 您可以使用CSS調整此按鈕的大小、外觀和位置。
...
選取此按鈕會將使用者導向到目錄中的上一頁。 此按鈕會出現在主控制列中。 此按鈕不會顯示在行動電話上，以節省熒幕空間。 您可以使用CSS調整此按鈕的大小、外觀和位置。
