---
description: 单击或点按此按钮可使用户转到目录中的下一页。 此按钮显示在主控件栏中。 此按钮不会显示在移动电话上以节省屏幕空间。 您可以使用CSS调整此按钮的大小、外观和位置。
seo-description: 单击或点按此按钮可使用户转到目录中的下一页。 此按钮显示在主控件栏中。 此按钮不会显示在移动电话上以节省屏幕空间。 您可以使用CSS调整此按钮的大小、外观和位置。
seo-title: 下一页按钮
...
单击或点按此按钮可使用户转到目录中的下一页。 此按钮显示在主控件栏中。 此按钮不会显示在移动电话上以节省屏幕空间。 您可以使用CSS调整此按钮的大小、外观和位置。
...
示例——设置一个28 x 28像素的下一页按钮，从主控件栏的底部放置4个像素，从右边缘放置250像素，并针对四个不同的按钮状态中的每一个显示不同的图像。
