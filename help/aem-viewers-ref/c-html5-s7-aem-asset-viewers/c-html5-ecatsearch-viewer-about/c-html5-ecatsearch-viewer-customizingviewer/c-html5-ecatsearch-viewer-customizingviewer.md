...
seo-title: 自定义eCatalog Search Viewer
solution: Experience Manager
title: 自定义eCatalog Search Viewer
topic: Dynamic media
...
创建自定义CSS时，请记住查看器将 `.s7ecatalogsearchviewer` 类分配给其容器DOM元素。 如果使用随命令一起传递的外部CSS文 `style=` 件，请在CSS规则的 `.s7ecatalogsearchviewer` 子代选择器中将类用作父类。 如果要在网页上执行嵌入样式，则还可以按如下方式将此选择器限定为容器DOM元素的ID:
...
使用CSS标记是构建响应式设计的CSS的最灵活方法，因为它不仅允许您目标设备屏幕大小，还允许您实际查看器大小，这对于响应式设计的页面布局可能非常有用。
...
以下是适用于eCatalog Search Viewer的用户界面元素参考文档：

* [“添加收藏夹”按钮](r-html5-ecatsearch-customize-addfavorite.md)
* [关闭按钮](r-html5-ecatsearch-customize-closebutton.md)
...
* [第一页按钮](r-html5-ecatsearch-customize-firstpagebutton.md)
...
* [大型下一页按钮](r-html5-ecatsearch-customize-largenextpagebutton.md)
* [大上一页按钮](r-html5-ecatsearch-customize-largepreviouspagebutton.md)
...
* [下一页按钮](r-html5-ecatsearch-customize-nextpagebutton.md)
...
* [缩览图按钮](r-html5-ecatsearch-customize-thumbnailsbutton.md)
