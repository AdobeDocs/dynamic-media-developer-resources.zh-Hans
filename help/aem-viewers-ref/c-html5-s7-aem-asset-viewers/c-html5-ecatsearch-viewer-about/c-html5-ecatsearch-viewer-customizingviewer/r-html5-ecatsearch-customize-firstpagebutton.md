---
title: 第一頁按鈕
description: 按一下或點選此按鈕會將使用者導向目錄中的第一個頁面。 此按鈕會顯示在桌上型電腦系統和平板電腦上的主要控制列中；在行動電話上，此按鈕會新增至次要控制列。 您可以使用CSS調整此按鈕的大小、外觀和位置。
...
選取或點選此按鈕會將使用者帶到目錄中的第一個頁面。 此按鈕會顯示在桌上型電腦系統和平板電腦上的主要控制列中；在行動電話上，此按鈕會新增至次要控制列。 您可以使用CSS調整此按鈕的大小、外觀和位置。
...
範例 — 設定第一個頁面按鈕，其大小為28 x 28畫素，位置從底部算起4畫素，從主控列的左邊緣算起220畫素。 最後，針對四種不同按鈕狀態分別顯示不同的影像。
