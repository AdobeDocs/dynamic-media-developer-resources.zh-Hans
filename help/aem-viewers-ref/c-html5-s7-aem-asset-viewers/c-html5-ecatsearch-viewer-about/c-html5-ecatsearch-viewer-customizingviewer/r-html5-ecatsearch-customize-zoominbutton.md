---
description: 单击或点按此按钮将放大主视图中的图像。 此按钮显示在主控件栏中。 此按钮不显示在移动电话上以节省屏幕空间。 您可以使用CSS调整此按钮的大小、外观和位置。
seo-description: 单击或点按此按钮将放大主视图中的图像。 此按钮显示在主控件栏中。 此按钮不显示在移动电话上以节省屏幕空间。 您可以使用CSS调整此按钮的大小、外观和位置。
seo-title: 放大按钮
...
单击或点按此按钮将放大主视图中的图像。 此按钮显示在主控件栏中。 此按钮不显示在移动电话上以节省屏幕空间。 您可以使用CSS调整此按钮的大小、外观和位置。
...
示例 — 设置一个28 x 28像素的放大按钮，从底部放置4个像素，从主控件条的右边缘放置103个像素，并针对四个不同的按钮状态中的每一个显示不同的图像。
