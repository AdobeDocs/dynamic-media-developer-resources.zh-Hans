---
title: 放大顯示按鈕
description: 選取此按鈕可放大主檢視中的影像。 此按鈕會出現在主控制列中。 此按鈕不會顯示在行動電話上，以節省熒幕空間。 您可以使用CSS調整此按鈕的大小、外觀和位置。
...
選取此按鈕可放大主檢視中的影像。 此按鈕會出現在主控制列中。 此按鈕不會顯示在行動電話上，以節省熒幕空間。 您可以使用CSS調整此按鈕的大小、外觀和位置。
...
範例 — 設定放大顯示按鈕，其大小為28 x 28畫素，位置為從底部算起4畫素，從主控列的右邊緣算起103畫素。 最後，針對四種不同按鈕狀態分別顯示不同的影像。
