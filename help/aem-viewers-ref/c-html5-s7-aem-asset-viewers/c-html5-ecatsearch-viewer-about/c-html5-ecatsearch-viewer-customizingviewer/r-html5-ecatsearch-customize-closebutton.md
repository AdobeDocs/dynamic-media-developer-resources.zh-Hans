---
title: “关闭”按钮
description: 单击或点按此按钮可关闭包含的网页。 仅当closebutton参数设置为1时，才会显示此按钮。 此按钮在桌面系统上不可用。 您可以使用CSS调整此按钮的大小、外观和位置。
...
示例 — 设置一个56 x 56像素的“关闭”按钮，并从主控制栏的顶部和右边缘放置4个像素。 最后，为四种不同的按钮状态分别显示不同的图像。
