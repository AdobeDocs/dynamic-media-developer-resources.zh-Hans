...
示例 — 设置位于查看器区域中心的300 x 200像素信息面板对话框；顶部有40像素填充，其他所有侧面有10像素填充，浅灰色背景以及10像素边框半径和投影。
...
示例 — 设置一个28 x 28像素的对话框关闭按钮，该按钮位于“信息面板”对话框上边缘和右边缘的5像素处，并且为四种不同的按钮状态中的每一种显示不同的图像。
