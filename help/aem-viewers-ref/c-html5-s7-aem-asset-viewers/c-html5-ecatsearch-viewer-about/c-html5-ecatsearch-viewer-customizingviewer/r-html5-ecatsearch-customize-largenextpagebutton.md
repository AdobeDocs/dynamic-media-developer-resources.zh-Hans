---
title: 大下一页按钮
description: 选择此按钮会将用户转至目录中的下一页。 此按钮显示在主控制栏中。 为了节省屏幕空间，此按钮不会显示在手机上。 您可以使用CSS调整此按钮的大小、外观和位置。
...
选择此按钮会将用户转至目录中的下一页。 此按钮显示在主控制栏中。 为了节省屏幕空间，此按钮不会显示在手机上。 您可以使用CSS调整此按钮的大小、外观和位置。
