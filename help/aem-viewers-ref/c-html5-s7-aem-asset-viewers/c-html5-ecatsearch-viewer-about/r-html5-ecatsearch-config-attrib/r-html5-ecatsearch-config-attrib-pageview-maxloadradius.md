...
<table id="table_985ADD6C9BD04C629A84C9C625CCCFEB"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>指定组件预载行为。 </p> <p>当设置为 <span class="codeph"> -1</span> 处于空闲状态时，该组件会预加载所有目录帧。 </p> <p> 当设置为 <span class="codeph"> 0</span> 组件仅加载可见的帧、上一帧和下一帧。 </p> <p>设置 <span class="codeph"><span class="varname"> preloadnbr</span></span> 定义在空闲状态下预加载当前显示帧周围的多少不可见帧。 </p> </td> 
  </tr> 
 </tbody> 
</table>
