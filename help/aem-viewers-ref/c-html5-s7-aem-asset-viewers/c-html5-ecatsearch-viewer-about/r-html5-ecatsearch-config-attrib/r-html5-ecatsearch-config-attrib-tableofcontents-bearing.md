...
<table id="table_5151E6EA076C4AAD8D952A09E1F17C44"> 
 <tbody> 
  <tr> 
   ...
   <td> <p> 控制下拉面板外观的方向。 </p> <p>当设置为 <span class="codeph"> 垂直适合</span>，组件首先将基础面板位置移动到其按钮的底部，并尝试将面板从基础位置向右或向左滚动。 在每次尝试时，组件都会检查面板是否被外部容器剪切。 如果所有尝试都失败，则组件会尝试将基础面板位置移至顶部，并在右侧和左侧重复转出尝试。 </p> <p>当设置为 <span class="codeph"> 拟合横向</span>，组件使用类似的逻辑，但首先将基面移动到右侧，然后尝试向下和向上转出方向。 然后，它向左移动基座，尝试向下和向上滚动方向。 </p> </td> 
  </tr> 
  <tr> 
