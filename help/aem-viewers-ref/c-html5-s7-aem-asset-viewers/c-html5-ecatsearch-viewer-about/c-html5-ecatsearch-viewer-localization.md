...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>电子邮件对话框右上角的关闭按钮。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>嵌入对话框右上角的关闭按钮。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>“链接”对话框右上角的关闭按钮。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>“当前页面”单选按钮的说明。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>“所有页面”单选按钮的说明。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>“每页1页”单选按钮的说明。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Print.PAGE_HANDLING_TWO </span> </p> </td> 
   <td colname="col2"> <p>“每页2页”单选按钮的说明。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在正常模式下“删除收藏夹”按钮。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>查看器在加载时生成的页面标签。 </p> <p>该符号的名称是模板，其中 <span class="codeph"> XX是横向从零开始的跨页索引，可选 </span> YY <span class="codeph"> 是XX所定位跨页内从零开始的页面索引 </span><span class="codeph"></span>。 </p> <p>仅适用于初始加载的资产；如果使用setAsset()API调用更改 <span class="codeph"> 了资产，则 </span> 将忽略此值。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> MediaSet.LABEL_DELIM </span> </p> </td> 
   <td colname="col2"> <p> 在为跨页中的左页和右页定义标签时，用作页面标签分隔符的字符。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>当搜索未返回任何结果时显示的本地化消息。 </p> <p>此符号支持以下运行时替换令牌： <span class="codeph"> $SEARCH_TEXT$ </span>。 组件将用用户输入的搜索文本替换它。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>为整个搜索面板定 <span class="codeph"> 义aria-label </span> ARIA属性的值。 </p> </td> 
  </tr> 
 </tbody> 
</table>
