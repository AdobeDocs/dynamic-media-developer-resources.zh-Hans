---
title: 向右迴轉按鈕
description: 按一下或點選此按鈕，可在主檢視的右側旋轉影像。 此按鈕不會顯示在行動電話上，以節省熒幕空間。 此外，當使用多維度迴轉集時，按鈕會隱藏。 您可以使用CSS調整按鈕的大小、外觀和位置。
...
# 向右迴轉按鈕{#spin-right-button}

按一下或點選此按鈕，可在主檢視的右側旋轉影像。 此按鈕不會顯示在行動電話上，以節省熒幕空間。 此外，當使用多維度迴轉集時，按鈕會隱藏。 您可以使用CSS調整按鈕的大小、外觀和位置。
...
範例 — 設定旋轉右側按鈕，此按鈕為28 x 28畫素，並位於內部容器的右邊緣。 最後，針對四種不同按鈕狀態分別顯示不同的影像：
