...
使用SDK API时，务必使用正确且完全限定的SDK命名空间，如 [查看器SDK](../../../c-html5-s7-aem-asset-viewers/c-html5-spin-viewer-about/c-html5-spin-viewer-namespace.md#concept-fa293878c9ff4758ae888415c70fbeef).
