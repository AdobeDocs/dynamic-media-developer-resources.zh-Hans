...
<table id="table_D5992FCFF26046079089652B211BB6C5"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>指定对帧更改应用的效果的类型。 属性<span class="codeph"> none </span>表示无过渡；帧更改会立即发生。 属性<span class="codeph">渐隐</span>表示旧帧和新帧之间的交叉渐隐过渡。 属性<span class="codeph">幻灯片</span>激活旧框架滑出视图和新框架滑入的过渡。 </p> </td> 
  </tr> 
  <tr> 
