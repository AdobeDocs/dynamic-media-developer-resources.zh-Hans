---
title: 设置指示器
description: 设置指示器是指在触摸设备上使用查看器时，在样本上方呈现的一系列点。 当滚动按钮不可用时，圆点可帮助用户浏览缩略图页面。
...
设置指示器是指在触摸设备上使用查看器时，在样本上方呈现的一系列点。 当滚动按钮不可用时，圆点可帮助用户浏览缩略图页面。
...
示例 — 要将设置指示器点创建为15 x 15像素，其中2像素水平边距、5像素上边距、1像素下边距、12像素半径、#D5D3D3种默认颜色和#939393种活动颜色：
