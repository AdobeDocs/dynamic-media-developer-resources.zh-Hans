...
返回对查看器使用的查看器SDK组件的引用。 网页可以使用此方法扩展或自定义现成查看器的行为。 仅在查看器回调运行 `initComplete` 后调用此方法；否则，查看器逻辑可能尚未创建该组件。
...
<table id="table_7B5DD9303EF44ADD847B13FFEAD135D9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 飞扬 </span> </p> </td> 
...
使用SDK API时，务必按照查看器SDK中的说明使用正确的完全限定的SDK [命名空间](../../../c-html5-s7-aem-asset-viewers/c-html5-inlinezoom-viewer-about/c-html5-inlinezoom-viewer-namespace.md#concept-5af3b472b320496d87735ea612edda80)。
