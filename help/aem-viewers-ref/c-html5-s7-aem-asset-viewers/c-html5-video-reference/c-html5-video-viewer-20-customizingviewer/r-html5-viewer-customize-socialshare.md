---
description: 默认情况下，社交共享工具显示在右上角。 它包含一个按钮和一个面板，当用户单击或点击某个按钮时该面板将展开并包含单独的共享工具。
seo-description: 默认情况下，社交共享工具显示在右上角。 它包含一个按钮和一个面板，当用户单击或点击某个按钮时该面板将展开并包含单独的共享工具。
seo-title: 社交共享
...
默认情况下，社交共享工具显示在右上角。 它包含一个按钮和一个面板，当用户单击或点击某个按钮时该面板将展开并包含单独的共享工具。
