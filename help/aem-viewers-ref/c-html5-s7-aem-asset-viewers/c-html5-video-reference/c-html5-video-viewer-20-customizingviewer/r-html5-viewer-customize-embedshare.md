...
示例 — 要设置带内边距的对话框标题，请使用24 x 14像素图标、粗体16点标题。 最后，一个28 x 28像素的关闭按钮，从顶部放置两个像素，从对话框容器右侧放置两个像素：
...
可以本地化对话框标签工具提示。 参见 [用户界面元素的本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad) 了解更多信息。
...
示例 — 设置嵌入代码，以便使用 `break-word` 自动换行：
...
示例 — 要将嵌入大小组合框设置为在显示预定义项目时为300像素宽，在显示自定义大小时为110像素宽：
...
打开组合框时会显示嵌入大小列表的面板，可通过以下CSS类选择器控制：
