...
如果系统无法播放视频，则显示的错误消息可以本地化。 有关详细信息，请参阅[用户界面元素的本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad)。
...
隐藏式字幕将放入视频播放器的内部容器中。 该容器的位置由支持的WebVTT定位操作符控制。 题注文本本身位于该容器中，其样式由以下CSS类选择器控制：
...
<table id="table_960E0D4FB91748FF9FC73C925B81879C"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>关闭字幕文本颜色。 </p> </td> 
  </tr> 
  <tr> 
