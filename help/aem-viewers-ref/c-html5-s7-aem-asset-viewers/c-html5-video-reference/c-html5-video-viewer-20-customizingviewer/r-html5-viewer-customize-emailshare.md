...
示例 — 要设置具有填充、24 x 17像素图标、粗体16点标题和28 x 28像素关闭按钮的对话框标题，距对话框容器顶部2像素，距右侧2像素：
...
可以本地化对话框标签。 有关详细信息，请参阅[用户界面元素本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad)。
...
从对话框主体左侧的标签扩展到右边的大多数输入字段（包括“from”字段和“message”字段）都受以下控件控制：
...
“收件人”输入字段较窄，因为它为右侧的“删除电子邮件”按钮分配了空间。 它通过以下CSS类选择器控制：
...
示例 — 设置一个表单，使其在所有输入字段周围有一个像素灰色边框，边框的边距为9个像素；要对验证失败的字段使用相同的红色边框，则输入字段的宽度为250像素，其余输入字段的宽度为300像素：
...
正在共享的内容显示在对话框正文的底部，包括缩略图、标题、来源URL和说明。 它包装在容器中，控制对象为：
...
错误消息可以本地化。 有关详细信息，请参阅[用户界面元素本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad)。
