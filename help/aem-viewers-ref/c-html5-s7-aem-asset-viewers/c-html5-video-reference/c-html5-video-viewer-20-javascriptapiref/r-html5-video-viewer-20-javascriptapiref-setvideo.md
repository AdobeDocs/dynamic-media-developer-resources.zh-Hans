...
设置新的外部视频和可选的其他视频数据。 可以随时在`init()`之前和之后调用。 如果在`init()`之后调用，查看器将在运行时交换视频。
  ...
  <tr> 
   ...
   <td colname="col2"> <p>{ <span class="codeph"> JSON </span>}个JSON对象，包含以下可选字段（区分大小写）： </p> <p> 
     <ul id="ul_26121393BC7145FF8A43C05ACCBEFF36"> 
      ...
      <li id="li_4659E82D38EB4438AAA04FDEAF21B087"> <span class="codeph"> 题 </span> 注 — 新题注文件的位置。如果未指定题注文件，则用户界面中不显示题注按钮。 </li> 
