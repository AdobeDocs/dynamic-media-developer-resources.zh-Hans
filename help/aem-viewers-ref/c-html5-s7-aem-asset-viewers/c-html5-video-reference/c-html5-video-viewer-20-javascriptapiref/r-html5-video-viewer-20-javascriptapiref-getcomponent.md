...
使用SDK API时，务必按照[查看器SDK命名空间](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-namespace.md#concept-679bfabb3e3e4c12a285c4e9c4144153)中的说明使用正确的完全限定的SDK命名空间。
