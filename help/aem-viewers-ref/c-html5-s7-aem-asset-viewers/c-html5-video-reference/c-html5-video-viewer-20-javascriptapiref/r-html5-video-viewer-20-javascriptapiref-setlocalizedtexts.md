...
<table id="table_896DFF34A68A403DB93A6D597461A573"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> { <span class="codeph">对象</span>}个JSON对象，含本地化数据。 </p> <p>有关详细信息，请参阅<a href="../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-namespace.md#concept-679bfabb3e3e4c12a285c4e9c4144153" format="dita" scope="local">查看器SDK命名空间</a>。 </p> <p>有关对象内容的详细信息，请参阅<i>查看器SDK用户指南</i>和示例。 可选。 </p> </td> 
  </tr> 
 </tbody> 
</table>
