  ...
  <tr> 
   ...
   <td colname="col2"> <p>{ <span class="codeph"> JSON </span>} JSON对象包含以下可选字段（区分大小写）: </p> <p> 
     <ul id="ul_26121393BC7145FF8A43C05ACCBEFF36"> 
      <li id="li_DA50E073F3D4460CBC34243A2CBCC895"> <span class="codeph"> 海报图 </span> 像——在视频开始播放之前要在第一帧上显示的图像。 请参 <a href="../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/c-html5-video-cmdref/r-html5-video-viewer-conf-attrib-videoplayer-posterimage.md#reference-9739abeeb9f64c02b5d2f7a0d1706103" format="dita" scope="local"> 阅VideoPlayer.posterimage </a>。 </li> 
      <li id="li_BBFF3965B69A4AC8A469FDB69097B25A"> <span class="codeph"> 题 </span> 注——新隐藏式题注文件的位置。 如果未指定文件，则隐藏式字幕按钮在用户界面中不可见。 </li> 
