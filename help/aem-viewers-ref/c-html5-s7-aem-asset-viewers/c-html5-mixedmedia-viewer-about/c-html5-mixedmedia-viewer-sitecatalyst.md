...
seo-description: 混合媒体查看器支持Adobe Analytics现成跟踪。
...
混合媒体查看器 [!DNL Adobe Analytics] 支持现成跟踪。 要启用跟踪，请将正确的公司预设名称作为参 `config2` 数传递。
...
<table id="table_5D090E6614974D968E1A93B5727D859C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>播放到达以下磨盘之一：0%、25%、50%、75%和100%。 </p> </td> 
  </tr> 
  <tr> 
