...
description: 混合媒體檢視器支援立即可用的Adobe Analytics追蹤功能。
...
混合媒體檢視器支援立即可用的Adobe Analytics追蹤功能。

## 現成可用的追蹤 {#section-ba994f079d0343c8ae48adffaa3195a3}

混合媒體檢視器支援 [!DNL Adobe Analytics] 追蹤現成可用的專案。 若要啟用追蹤，請將適當的公司預設集名稱傳遞為 `config2` 引數。
