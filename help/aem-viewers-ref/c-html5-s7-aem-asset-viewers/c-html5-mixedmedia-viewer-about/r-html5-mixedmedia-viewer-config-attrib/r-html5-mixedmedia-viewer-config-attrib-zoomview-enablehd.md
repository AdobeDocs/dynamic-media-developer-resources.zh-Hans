...
<table id="table_0BEA0B5FFDF64E5594B534B2A87A6D88"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 启用、限制或禁用设备优化，其中 <span class="codeph"> devicePixelRatio</span> 大于 <span class="codeph"> 1</span>，即配备高密度显示器的设备，如iPhone4和类似设备。 如果激活，则组件限制IS图像请求的大小，就像设备只有像素比一样 <span class="codeph"> 1</span> 这样就可以减少带宽。 </p> <p>请参阅下面的示例2。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"><span class="varname"> 数字</span></span> </p> </td> 
   <td colname="col2"> <p> 如果使用limit设置，则组件启用高像素密度，但最多只能到指定的限制值。 </p> <p>请参阅下面的示例2。 </p> </td> 
  </tr> 
 </tbody> 
</table>
