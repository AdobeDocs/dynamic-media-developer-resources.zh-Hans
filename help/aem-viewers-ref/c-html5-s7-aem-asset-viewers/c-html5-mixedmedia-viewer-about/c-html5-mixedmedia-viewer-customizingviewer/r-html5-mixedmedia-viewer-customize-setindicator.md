---
description: 设置指示器是在触控设备上使用查看器时在主色板上呈现的一系列点。 当滚动按钮不可用时，这些点可帮助用户在缩略图的各页之间导航。
seo-description: 设置指示器是在触控设备上使用查看器时在主色板上呈现的一系列点。 当滚动按钮不可用时，这些点可帮助用户在缩略图的各页之间导航。
seo-title: 设置指示符
...
设置指示器是在触控设备上使用查看器时在主色板上呈现的一系列点。 当滚动按钮不可用时，这些点可帮助用户在缩略图的各页之间导航。
