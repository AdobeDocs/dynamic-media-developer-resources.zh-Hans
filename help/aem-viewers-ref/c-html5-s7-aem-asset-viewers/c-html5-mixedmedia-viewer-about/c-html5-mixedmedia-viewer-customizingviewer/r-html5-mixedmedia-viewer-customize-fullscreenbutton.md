---
title: 全屏按钮
description: 用户选择此按钮后，查看器将进入或退出全屏模式。 当查看器显示图像或旋转集时，将使用该属性。 如果查看器在弹出模式下工作，并且系统不支持本机全屏，则不会显示此按钮。 您可以使用CSS调整此按钮的大小、外观和位置。
...
用户选择此按钮后，查看器将进入或退出全屏模式。 当查看器显示图像或旋转集时，将使用该属性。 如果查看器在弹出模式下工作，并且系统不支持本机全屏，则不会显示此按钮。 您可以使用CSS调整此按钮的大小、外观和位置。
