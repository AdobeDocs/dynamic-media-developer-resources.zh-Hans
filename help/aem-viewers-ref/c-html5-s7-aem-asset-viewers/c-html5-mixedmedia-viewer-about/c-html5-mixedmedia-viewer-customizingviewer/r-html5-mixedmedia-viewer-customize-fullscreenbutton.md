---
description: 当用户单击此按钮时，查看器将进入或退出全屏模式。 查看器显示图像或旋转集时使用它。 如果查看器在弹出模式下工作，且系统不支持本机全屏，则不显示此按钮。 您可以使用CSS调整此按钮的大小、外观和位置。
seo-description: 当用户单击此按钮时，查看器将进入或退出全屏模式。 查看器显示图像或旋转集时使用它。 如果查看器在弹出模式下工作，且系统不支持本机全屏，则不显示此按钮。 您可以使用CSS调整此按钮的大小、外观和位置。
seo-title: 全屏按钮
...
当用户单击此按钮时，查看器将进入或退出全屏模式。 查看器显示图像或旋转集时使用它。 如果查看器在弹出模式下工作，且系统不支持本机全屏，则不显示此按钮。 您可以使用CSS调整此按钮的大小、外观和位置。
