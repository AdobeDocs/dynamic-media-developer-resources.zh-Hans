---
title: 全熒幕按鈕
description: 當使用者選取此按鈕時，檢視器會進入或退出全熒幕模式。 當檢視器顯示影像或迴轉集時，就會使用它。 如果檢視器在快顯視窗模式下運作且系統不支援原生全熒幕，則不會顯示此按鈕。 您可以使用CSS調整此按鈕的大小、外觀和位置。
...
當使用者選取此按鈕時，檢視器會進入或退出全熒幕模式。 當檢視器顯示影像或迴轉集時，就會使用它。 如果檢視器在快顯視窗模式下運作且系統不支援原生全熒幕，則不會顯示此按鈕。 您可以使用CSS調整此按鈕的大小、外觀和位置。
