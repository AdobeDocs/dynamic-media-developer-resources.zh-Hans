---
title: “关闭”按钮
description: 单击或点按此按钮可关闭包含的网页。 仅当closebutton参数设置为1时，才会显示此按钮。 您可以使用CSS调整此按钮的大小、外观和位置。
...
选择此按钮将关闭包含的网页。 仅当closebutton参数设置为1时，才会显示此按钮。 您可以使用CSS调整此按钮的大小、外观和位置。
...
示例 — 设置一个32 x 32像素的关闭按钮，并放置离查看器上边缘和右边缘六个像素的位置。 最后，为四种不同的按钮状态中的每种状态显示不同的图像。
