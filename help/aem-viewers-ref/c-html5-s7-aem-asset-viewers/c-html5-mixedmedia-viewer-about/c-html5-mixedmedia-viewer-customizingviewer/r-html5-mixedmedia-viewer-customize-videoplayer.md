...
系统无法播放视频时显示的错误消息可本地化。 有关 [详细信息，请参阅用户界面元素的本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-mixedmedia-viewer-about/c-html5-mixedmedia-viewer-localization.md#concept-16262b8096474d6c9c018c3e99110dd1) 。
...
字幕将放入视频播放器的内部容器中。 该容器的位置由支持的WebVTT定位操作员控制。 题注文本本身在该容器中；其样式由以下CSS类选择器控制：
...
示例——要在半透明黑色背景上将题注文本设置为14像素浅灰色Arial，请执行以下操作：
