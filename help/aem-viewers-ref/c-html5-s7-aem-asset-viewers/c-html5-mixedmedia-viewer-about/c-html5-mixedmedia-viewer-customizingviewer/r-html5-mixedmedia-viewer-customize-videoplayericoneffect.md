---
description: 播放图标将覆盖在视频视图区域上。 它在暂停视频或到达视频结尾时显示，并且还取决于iconeffect参数。
seo-description: 播放图标将覆盖在视频视图区域上。 它在暂停视频或到达视频结尾时显示，并且还取决于iconeffect参数。
seo-title: 视频播放器图标效果
...
播放图标将覆盖在视频视图区域上。 它在暂停视频或到达视频结尾时显示，并且还取决于iconeffect参数。
