...
当用户选择视频内容时，“播放/暂停”按钮会导致视频播放器播放或暂停视频内容。
...
>
>`replay='true'`此属性在视频结束时设置，选择按钮可从头开始重新播放。
...
设置一个32 x 32像素的播放/暂停按钮，该按钮位于控制栏上边缘和左边缘的6个像素处。 最后，在选中或未选中时，为四种不同的按钮状态中的每种状态显示不同的图像。
