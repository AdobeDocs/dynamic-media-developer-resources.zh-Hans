...
视频清洗工具提示可以本地化。 有关更多信息，请参阅[用户界面元素的本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-mixedmedia-viewer-about/c-html5-mixedmedia-viewer-localization.md#concept-16262b8096474d6c9c018c3e99110dd1) 。

## 示例 {#section-e8caea0a303c425a8a637c2a47c06355}

要设置混合媒体查看器，请使用高10像素的自定义跟踪颜色进行视频清理，并且该查看器距离控制栏的上边缘和左边缘有10像素和35像素。
