---
title: 视频全屏按钮
description: 用户选择全屏按钮后，查看器将进入或退出全屏模式。 当查看器显示视频并位于控制栏中时使用。 如果查看器在弹出模式下工作，并且系统不支持本机全屏，则不会显示此按钮。
...
如果用户选择“全屏”按钮，查看器将进入或退出全屏模式。 当查看器显示视频并位于控制栏中时使用。 如果查看器在弹出模式下工作，并且系统不支持本机全屏，则不会显示此按钮。
