...
示例 — 设置位于查看器区域中心的300 x 200像素信息面板对话框。 它的顶部有40个像素的内边距，其他所有侧面有10个像素的内边距，浅灰色背景，10个像素的边框半径和投影。
...
示例 — 要设置一个对话框“关闭”按钮，该按钮为28 x 28像素，距“信息”面板对话框的上边缘和右边缘5像素。 最后，针对四个不同的按钮状态中的每个状态显示一个不同的图像。
