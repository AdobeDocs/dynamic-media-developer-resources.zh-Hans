...
示例 — 设置居中在查看器区域中的300 x 200像素信息面板对话框。 它顶部有40像素的边距，其他所有边有10像素的边距，浅灰色背景，10像素边框半径和投影。
...
示例 — 设置对话框关闭按钮，该按钮为28 x 28像素，位于距信息面板对话框上边缘和右边缘5像素的位置。 最后，为四种不同的按钮状态分别显示不同的图像。
