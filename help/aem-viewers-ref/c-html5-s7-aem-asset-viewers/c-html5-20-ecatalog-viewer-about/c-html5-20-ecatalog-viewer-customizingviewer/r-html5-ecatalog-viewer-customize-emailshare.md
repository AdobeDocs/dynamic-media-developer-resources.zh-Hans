...
可以本地化“关闭”按钮工具提示和对话框标题。 请参阅 [用户界面元素的本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) 以了解更多信息。
...
可以本地化此按钮的工具提示。 请参阅 [用户界面元素的本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) 以了解更多信息。
...
>[!NOTE]
>
>此消息支持 `state` 属性选择器，可能的值如下： `verifyerror`， `senderror`、和 `sendsuccess`. 值 `verifyerror` 在由于内联输入验证失败而显示消息时设置。 值 `senderror` 在后端电子邮件服务报告错误时设置。 值  `sendsuccess` 在成功发送电子邮件时设置。 这样，就可以根据对话框状态对消息设置不同的样式。
