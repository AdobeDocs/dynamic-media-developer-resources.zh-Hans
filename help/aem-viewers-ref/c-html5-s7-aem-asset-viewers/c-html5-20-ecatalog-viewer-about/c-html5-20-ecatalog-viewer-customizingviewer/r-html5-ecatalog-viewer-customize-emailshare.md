...
“关闭”按钮工具提示和对话框标题可以本地化。 有关 [详细信息，请参阅用户界面元素的本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) 。

示例——设置具有填充、24 x 17像素图标、粗体16点标题和28 x 28像素“关闭”按钮的对话框标题，该按钮距对话框容器的顶部和右侧分别放置两个像素和两个像素：
...
此按钮工具提示可以本地化。 有关 [详细信息，请参阅用户界面元素的本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) 。
...
对话框标签可以本地化。 有关 [详细信息，请参阅用户界面元素的本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) 。
...
从对话框主体左边的标签到右边缘（包括“从”字段和“消息”字段）扩展的大多数输入字段都通过以下CSS类选择器进行控制：
...
示例——将表单设置为在所有输入字段周围有一个像素灰色边框，边框的边距为9像素；对于未通过验证的字段，要使用红色的相同边框，则“至”字段的宽度为250像素，其余输入字段的宽度为300像素：
...
正在共享的内容显示在对话框正文的底部，并包括缩略图、标题、来源URL和说明。 它被包装到由以下CSS类选择器控制的容器中：
