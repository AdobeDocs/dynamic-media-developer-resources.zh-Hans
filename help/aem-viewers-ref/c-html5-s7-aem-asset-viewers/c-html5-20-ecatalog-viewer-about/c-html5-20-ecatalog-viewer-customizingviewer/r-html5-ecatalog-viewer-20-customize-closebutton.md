---
description: 单击或点按此按钮可关闭包含的网页。 此按钮仅在closebutton参数设置为1时显示。 此按钮在桌面系统上不可用。 您可以使用CSS调整此按钮的大小、外观和位置。
seo-description: 单击或点按此按钮可关闭包含的网页。 此按钮仅在closebutton参数设置为1时显示。 此按钮在桌面系统上不可用。 您可以使用CSS调整此按钮的大小、外观和位置。
seo-title: 关闭按钮
...
单击或点按此按钮可关闭包含的网页。 此按钮仅在closebutton参数设置为1时显示。 此按钮在桌面系统上不可用。 您可以使用CSS调整此按钮的大小、外观和位置。
...
示例——设置一个56 x 56像素的关闭按钮，该按钮距主控件条的上边缘和右边缘有4个像素，并为四个不同按钮状态中的每个状态显示一个不同的图像。
