---
title: Close button
description: Selecting or tapping this button closes the containing web page. 仅当closebutton参数设置为1时，才会显示此按钮。 此按钮在桌面系统上不可用。 您可以使用CSS调整按钮的大小、外观和位置。
...
The button tool tip can be localized. 请参阅 [用户界面元素的本地化](../../../c-html5-s7-aem-asset-viewers/c-html5-20-ecatalog-viewer-about/c-html5-20-ecatalog-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) 以了解更多信息。
