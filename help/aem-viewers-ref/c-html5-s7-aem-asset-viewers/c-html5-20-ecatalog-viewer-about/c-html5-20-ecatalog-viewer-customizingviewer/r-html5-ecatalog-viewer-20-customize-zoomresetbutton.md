---
title: 缩放重置按钮
description: 选择或点按此按钮可重置主视图中的图像。 此按钮显示在桌面系统和平板电脑的主控制栏中。 在手机上，此按钮显示在图像底部的正上方。 但是，当图像处于重置状态时，不会显示它。 您可以使用CSS调整此按钮的大小、外观和位置。
...
选择或点按此按钮可重置主视图中的图像。 此按钮显示在桌面系统和平板电脑的主控制栏中。 在手机上，此按钮显示在图像底部的正上方。 但是，当图像处于重置状态时，不会显示它。 您可以使用CSS调整此按钮的大小、外观和位置。
...
<table id="table_94EE3F5BBE4547C0B4943471CEE7EDE4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>从主控制栏（在台式机和平板电脑上）或查看器（在手机上）的顶部边框定位，包括填充。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>从主控制栏（在台式机和平板电脑上）或查看器（在手机上）的左边框定位，包括填充。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 底部 </span> </p> </td> 
   <td colname="col2"> <p>从主控制栏（在台式机和平板电脑上）或查看器（在手机上）的底部边框定位，包括填充。 </p> </td> 
  </tr> 
  <tr> 
...
示例 — 设置一个28 x 28像素的缩放重置按钮，该按钮位于桌面上，距底部仅4像素，距主控栏右边缘仅47像素。 最后，为四种不同的按钮状态中的每种状态显示不同的图像。
