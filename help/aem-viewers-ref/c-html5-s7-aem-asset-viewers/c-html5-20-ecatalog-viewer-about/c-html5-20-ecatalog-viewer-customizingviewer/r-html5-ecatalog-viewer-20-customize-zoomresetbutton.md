---
title: 缩放重置按钮
description: 选择或点击此按钮可在主视图中重置图像。 此按钮显示在桌面系统和平板电脑的主控制栏中。 在手机上，此按钮显示在图像的底部正上方。 但是，当图像处于重置状态时，不会显示该图像。 您可以使用CSS调整此按钮的大小、外观和位置。
...
选择或点击此按钮可在主视图中重置图像。 此按钮显示在桌面系统和平板电脑的主控制栏中。 在手机上，此按钮显示在图像的底部正上方。 但是，当图像处于重置状态时，不会显示该图像。 您可以使用CSS调整此按钮的大小、外观和位置。
