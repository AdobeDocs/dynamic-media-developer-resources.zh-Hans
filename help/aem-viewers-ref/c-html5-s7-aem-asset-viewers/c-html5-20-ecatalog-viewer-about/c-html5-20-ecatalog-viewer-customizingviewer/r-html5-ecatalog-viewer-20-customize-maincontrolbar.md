---
description: 主控制栏是桌面系统和平板电脑上的矩形区域，其中包含eCatalog查看器可用的所有用户界面控件（大页按钮除外）。
seo-description: 主控制栏是桌面系统和平板电脑上的矩形区域，其中包含eCatalog查看器可用的所有用户界面控件（大页按钮除外）。
seo-title: 主控制栏
...
主控制栏是桌面系统和平板电脑上的矩形区域，其中包含eCatalog查看器可用的所有用户界面控件（大页按钮除外）。
