...
description: Clicking or tapping on this button brings the user to the previous page in the catalog. 此按钮显示在主控制栏中。 此按钮不显示在手机上以节省屏幕资产。 You can size, skin, and position this button by using CSS.
