...
清理器“旋钮”也会随着视频播放而移动，以指示视频在播放期间的当前时间位置。 视频清理器始终占据控制栏的整个宽度。 可以通过CSS为视频洗刷设置外观、更改其高度和垂直位置。
...
可以本地化视频洗刷工具提示。 参见 [用户界面元素的本地化](../../../c-html5-aem-asset-viewers/c-html5-aem-smartcropvideo/r-html5-aem-smartcropvideo-viewer-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad) 了解更多信息。

**示例**  — 设置一个视频查看器，该视频查看器带有自定义跟踪颜色的视频清理器，高度为10像素。 最后，请将其定位在距离控制栏的上边缘和左边缘10个像素和35个像素的位置。
