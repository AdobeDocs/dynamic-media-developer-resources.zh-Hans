...
适用于智能裁剪视频查看器的JavaScript API引用

`setVideo(videoUrl[, data])`

设置新的外部视频和可选的其他视频数据。 可以在之前和之后随时调用 `init()`. 如果在 `init()`，则查看器会在运行时交换视频。
  ...
  <tr> 
   ...
   <td colname="col2"> <p>{ <span class="codeph"> JSON </span>} JSON对象，其中包含以下可选字段（区分大小写）： </p> <p> 
     <ul id="ul_26121393BC7145FF8A43C05ACCBEFF36"> 
      ...
      <li id="li_4659E82D38EB4438AAA04FDEAF21B087"> <span class="codeph"> 字幕 </span>  — 新标题文件的位置。 如果未指定字幕文件，则在用户界面中不显示字幕按钮。 </li> 
