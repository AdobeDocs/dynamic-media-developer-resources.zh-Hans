---
title: 使用者介面元素的本地化
description: Smart Crop Video Viewer顯示的某些內容必須經過本地化。 此內容包含使用者介面元素工具提示，以及在無法播放視訊時顯示的錯誤訊息。
...
Smart Crop Video Viewer顯示的某些內容必須經過本地化。 此內容包含使用者介面元素工具提示，以及在無法播放視訊時顯示的錯誤訊息。
