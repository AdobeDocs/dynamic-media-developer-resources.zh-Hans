...
seo-description: 视频图像查看器的JavaScript API参考
...
<table id="table_98A620DAE2C340FA97BF7204AE023CC8"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <span class="codeph"> {Object} </span> JSON对象，查看器事件回调。 属性名称是支持的查看器事件的名称。 属性值是对相应回调的JavaScript函数引用。 </p> <p>有关查 <a href="../../../c-html5-aem-asset-viewers/c-html5-aem-interactive-images/c-html5-aem-interactive-image-event-callbacks.md#concept-66d5996f2b1b44cab3d5264cda5c50cd" format="dita" scope="local"> 看器事件 </a> 的更多信息，请参阅事件回调。 </p> </td> 
  </tr> 
 </tbody> 
</table>
