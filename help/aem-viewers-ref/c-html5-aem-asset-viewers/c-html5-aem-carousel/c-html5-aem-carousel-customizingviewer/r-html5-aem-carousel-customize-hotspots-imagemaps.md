...
<table id="table_DAE7A78AA4A74DC78B2D94F29E8E236B"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>图像映射区域填充颜色。 </p> <p>指定此颜色于 <span class="codeph"> #RRGGBB </span>， <span class="codeph"> RGB(R，G，B) </span>，或 <span class="codeph"> RGBA(R，G，B，A) </span> 格式。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 图像映射区域边框样式。 应指定为'' <span class="codeph"> 宽度 </span> <span class="codeph"> 纯色 </span>“”，其中 <span class="codeph"> 宽度 </span> 以像素表示，并且 <span class="codeph"> 颜色 </span> 设置为 <span class="codeph"> #RRGGBB </span>， <span class="codeph"> RGB(R，G，B) </span>，或 <span class="codeph"> RGBA(R，G，B，A) </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
