---
description: 轮播查看器是一个查看器，它以轮播方式显示带有可单击热点或区域的不可缩放的横幅图像。 此查看器旨在实施“可购式轮播”体验，以便用户在横幅图像上选择热点或区域，然后被重定向到客户网站上的“概览”或产品详细信息页面。 它适用于台式机和移动设备。
...
轮播查看器是一个查看器，它以轮播方式显示带有可单击热点或区域的不可缩放的横幅图像。 此查看器旨在实施“可购式轮播”体验，以便用户在横幅图像上选择热点或区域，然后被重定向到客户网站上的“概览”或产品详细信息页面。 它适用于台式机和移动设备。
