...
<table id="table_06B5F795889E402FB6BCEA4D882E1422"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 应用于横幅图像的图像服务命令字符串。 如果在URL中指定，则&amp;和 <span class="codeph"> =的所有出现都必须以HTTP编码，分别为</span> %26 <span class="codeph"> 和</span><span class="codeph"></span><span class="codeph"></span>%3D Exconded。 </p> </td> 
  </tr> 
 </tbody> 
</table>
