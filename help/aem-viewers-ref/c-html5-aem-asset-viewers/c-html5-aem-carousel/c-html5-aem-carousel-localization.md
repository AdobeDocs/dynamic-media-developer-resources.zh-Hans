---
description: 旋转式查看器显示的某些内容受本地化的约束。 这包括幻灯片导航按钮。
seo-description: 旋转式查看器显示的某些内容受本地化的约束。 这包括幻灯片导航按钮。
seo-title: 本地化用户界面元素
...
旋转式查看器显示的某些内容受本地化的约束。 这包括幻灯片导航按钮。
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 传送视图。USAGE_HINT  </span> </p> </td> 
