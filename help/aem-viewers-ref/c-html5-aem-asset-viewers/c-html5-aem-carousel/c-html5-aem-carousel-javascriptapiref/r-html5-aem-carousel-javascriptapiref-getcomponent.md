...
<table id="table_7B5DD9303EF44ADD847B13FFEAD135D9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> 控制栏 </span> </p> </td> 
...
在使用SDK API时，请务必使用正确的完全限定的SDK命名空间，如中所述 [Viewer SDK命名空间](../../../c-html5-aem-asset-viewers/c-html5-aem-carousel/c-html5-aem-carousel-namespace.md).
