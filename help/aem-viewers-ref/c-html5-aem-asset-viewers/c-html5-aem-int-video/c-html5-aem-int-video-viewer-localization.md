---
description: 交互式视频查看器显示的某些内容受本地化的约束。 这包括用户界面元素工具提示以及视频无法播放时显示的错误消息。
seo-description: 交互式视频查看器显示的某些内容受本地化的约束。 这包括用户界面元素工具提示以及视频无法播放时显示的错误消息。
seo-title: 本地化用户界面元素
...
交互式视频查看器显示的某些内容受本地化的约束。 这包括用户界面元素工具提示以及视频无法播放时显示的错误消息。
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 选定的隐藏字幕按钮状态。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> ClosedCaptionButton.TOOLTIP_UNSELECTED  </span> </p> </td> 
   <td colname="col2"> <p> 取消选择的隐藏字幕按钮状态。 </p> </td> 
  </tr> 
  <tr> 
