---
description: 默认情况下，社交共享工具显示在右上角。 它由按钮和面板组成，当用户单击或点按按钮时该面板展开并包含各个共享工具。
seo-description: 默认情况下，社交共享工具显示在右上角。 它由按钮和面板组成，当用户单击或点按按钮时该面板展开并包含各个共享工具。
seo-title: 社交共享
...
默认情况下，社交共享工具显示在右上角。 它由按钮和面板组成，当用户单击或点按按钮时该面板展开并包含各个共享工具。
...
要设置社交共享工具，该工具距查看器容器顶部4个像素，距右侧5个像素，大小为28 x 28像素。
...
设置社交共享工具按钮，该按钮为四个不同的按钮状态中的每个状态显示不同的图像。
