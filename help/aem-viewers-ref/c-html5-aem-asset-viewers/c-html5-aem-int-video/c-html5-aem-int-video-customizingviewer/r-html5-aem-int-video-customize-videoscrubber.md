...
视频擦洗器工具提示可以本地化。 有关 [详细信息，请参阅用户界面元素的本地化](../../../c-html5-aem-asset-viewers/c-html5-aem-int-video/c-html5-aem-int-video-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) 。
...
>[!NOTE]
>
>此按钮支持属 `state` 性选择器，您可以使用它将不同的外观应用到不同的按钮状态。 特别是，与默 `selected='default'` 认的视频章节标记状态相对应，并且当通过鼠标悬停或触摸手势 `selected='over'` 激活视频章节标记时，将使用该标记。
