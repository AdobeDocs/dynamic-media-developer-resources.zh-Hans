---
title: 题注按钮
description: 此按钮可打开和关闭隐藏式字幕显示。 如果未指定题注参数，则不会显示此字段。
...
此按钮可打开和关闭隐藏式字幕显示。 如果未指定题注参数，则不会显示此字段。

<!--<a id="section_061E550C1C1D4DB2BD663A898895B38C"></a>-->

使用CSS，您可以相对于包含该按钮的控制栏调整其大小、外观和位置。
...
设置隐藏式字幕按钮（28 x 28像素） 按钮必须位于距离控制栏顶部四个像素和距离控制栏右边缘68个像素的位置。 此外，在选择或未选择时，必须为四种不同的按钮状态中的每一种显示不同的图像。
