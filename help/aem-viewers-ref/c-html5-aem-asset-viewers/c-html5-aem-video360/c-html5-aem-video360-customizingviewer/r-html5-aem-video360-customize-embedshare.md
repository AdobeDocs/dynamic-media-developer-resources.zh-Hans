...
<table id="table_C48C56E696304C9BAFEE71BA9EA9A174"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 在图稿Sprite中定位（如果使用CSS Sprite）。 </p> <p>另请参 <a href="../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-customizingviewer/c-html5-aem-video360-customizingviewer.md#section-9b6d8d601cb441d08214dada7bb4eddc" format="dita" scope="local"> 阅CSS Sprite </a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
**示例** -设置一个28 x 28像素的嵌入共享按钮，并为四个不同的按钮状态中的每一个状态显示一个不同的图像：
...
**示例** -设置具有填充、24 x 14像素图标、粗体16点标题和28 x 28像素关闭按钮的对话框标题，从顶部放置两个像素，从对话框容器右侧放置两个像素：
...
**示例** -要设置一个对话框的页脚，其中带有64 x 34“取消”按钮，其文本颜色和背景颜色对于每个按钮状态都不同：
...
**示例** -要设置主对话框区域，使其高度为300像素，边距为10像素，并使用白色背景：
...
对话框标签可以本地化。 有关 [详细信息，请参阅用户界面元素的本地化](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-localization.md#concept-16262b8096474d6c9c018c3e99110dd1) 。
...
**示例** -要在嵌入代码文本周围设置一个像素灰色边框，使其宽度为430像素，并且填充10像素：
...
**示例** -要设置一个滚动条缩略图，该缩略图为28 x 45像素，在顶部和底部有十个像素边距，并且每个状态的图稿都不同：
