...
使用SDK API时，务必按照[查看器SDK命名空间](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621)中的说明使用正确的完全限定的SDK命名空间。

有关特定组件的详细信息，请参阅&#x200B;*HTML5查看器SDK API*&#x200B;文档。
