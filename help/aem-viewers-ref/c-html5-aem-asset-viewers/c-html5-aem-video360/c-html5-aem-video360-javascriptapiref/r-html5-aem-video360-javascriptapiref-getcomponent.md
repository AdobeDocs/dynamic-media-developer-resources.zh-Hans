...
使用SDK API时，务必按照查看器SDK命名空间中的说明使用正确的完全 [限定的SDK命名空间](../../../c-html5-aem-asset-viewers/c-html5-aem-video360/c-html5-aem-video360-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621)。

有关特 *定组件的更多信息，请参阅HTML5查看器SDK API* 文档。
