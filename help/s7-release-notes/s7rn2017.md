...
Adobe Experience Cloud中Adobe Dynamic Media Classic部分的Adobe Experience Manager解决方案的最新发行说明。

## Dynamic Media发行说明 {#topic-1f5af440670a42f3bbb662eb86a196c6}

Adobe Dynamic Media Classic部分的最新发行说明 [!DNL Adobe Experience Manager] 解决方案 [!DNL Adobe Experience Cloud].
...
* HTML5视频
   ...
   * 如果托管HTML页面是从外部服务器(而不是Dynamic Media服务器)提供的，则视频字幕需要公司规则集。 请联系Adobe支持以获取帮助。
