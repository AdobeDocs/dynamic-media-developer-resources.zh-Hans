...
最新的发行说明，供Adobe [!DNL Dynamic Media] Classic -Adobe Experience Cloud中Adobe Experience Manager解决方案的一部分。
...
* [[!DNL Dynamic Media] 图像提供6.3.2和图像呈现6.3.2](s7rn2017.md#section-19a3e96f52c74757bcdea0f8a11001f2)
...
* HTC移动设备
   ...
   * HTC移动设备在Adobe的发现中显示，无法禁用本机捏合缩放是HTC UI包装器(HTC Sense)的“功能”。 当在查看器上使用“捏合缩放”手势时，此问题可能会导致整个页面缩放。 建议改用双击。
...
* HTML5视频
   ...
   * 如果托管HTML页面的视频字幕是从外部服务器(而不是 [!DNL Dynamic Media] 服务器)。 请联系Adobe支持以获取帮助。
...
## [!DNL Dynamic Media] 图像提供6.3.2和图像呈现6.3.2 {#section-19a3e96f52c74757bcdea0f8a11001f2}
