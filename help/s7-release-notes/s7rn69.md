...
* [Scene7 Publishing System 6.9版本要点](s7rn69.md#section-2ed72b7902be4509876d81f25b5632ce)
...
* 提高了弹性可扩展性和编码性能。
* 现成可用的`Universal_HTML5_MixedMedia_dark`和`Universal_HTML5_MixedMedia_light`查看器中现在提供视频字幕。 请参阅[在视频中添加题注](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/video/adding-captions-video.html#video)。
...
* 渲染服务器请求的安全测试 — 核心图像服务资源和视频资产的安全测试现在已扩展到也包括晕影。 在公开资产之前，请参阅[测试资产](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/upload-publish/testing-assets-making-them-public.html#upload-publish)。
* 监控失效CDN缓存功能。 选择CDN失效模板（请参阅[常规设置](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/setup/application-setup.html#general-settings)）并发出&#x200B;**[!UICONTROL 使CDN失效]**&#x200B;请求后，现在会弹出一个指示器，用于估计清除缓存所需的时间。

## 查看器 {#section-fc0577722d0b431dae3506c8d4e5366f}

**Scene7 HTML5 Viewer SDK 2.8.1**&#x200B;的新增功能、增强功能和错误修复
...
针对Scene7 OnDemand5.0.2 **的**&#x200B;错误修复

* 固定 — 嵌入的修饰符未包含在引号中

**Dynamic Media Image Serving Viewers 5.1.1}的新增功能、增强功能和错误修复**
...
* 添加了对使用HTML5弹出查看器的`highlightmode`修饰符显示窄图像的支持
* 添加了对使用HTML5弹出查看器的`zoomfactor`修饰符控制图像升级的支持。
...
* 海报图像可能遇到“最大大小”错误。 因此，您必须增加图像服务Publish的限制设置。
