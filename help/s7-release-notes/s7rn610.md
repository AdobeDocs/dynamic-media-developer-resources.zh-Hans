...
<table id="table_E78C924E34894CD7BE080C0D71500784"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>将</span>上的高分辨率预加载设置为<span class="uicontrol">将高品质加载配置的帧范围。 启用此设置可以显着增加带宽使用量和页面加载时间。 </p> </td>
  </tr>
 </tbody>
</table>
...
<table id="table_8B704CC077304CE2AC3E616D40B64CEF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 在上载文件夹作业中删除临时文件之前等待的时间（以秒为单位）。 </p> <p>值为<span class="codeph"> &lt;= 0 </span>可阻止删除临时文件。 默认值为3600。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> autoset.dupcheck.sleep.time </span> </p> </td> 
   <td colname="col2"> <p>默认值为100。 </p> </td>
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> autoset.dupretry.counter </span> </p> </td> 
   <td colname="col2"> <p>默认值为3。 </p> </td>
  </tr> 
 </tbody> 
</table>
...
* 修复了s7sdk.browser.device.version错误地检测到第五个™的问题。
