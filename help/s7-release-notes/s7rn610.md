...
* [Scene7 Publishing System 6.10发行亮点](s7rn610.md#section-d2c3b12e392446868eba029cbe13c06b)
...
## Scene7 Publishing System 6.10发行亮点 {#section-d2c3b12e392446868eba029cbe13c06b}
...
* **添加到现成HTML5旋转集查看器的新设置** — 在&#x200B;**[!UICONTROL 设置]** > **[!UICONTROL 应用程序设置]** > **[!UICONTROL 查看器]** > **[!UICONTROL 查看器预设]** > `Universal_HTML5_SpinSet_dark`或`Universal_HTML5_SpinSet_light`中，对每个查看器的[!DNL Configure Viewer]页面进行了以下添加：
...
* IPS Classic Publish验证中的目录服务器重新同步选项 — 已删除。
* 不能再设置空的或重复的元数据标记字段值。
...
**Dynamic Media Image Serving Viewers 5.2.2**&#x200B;的新增功能、增强功能和错误修复

查看器升级可向后兼容 — 无需对现有Web代码进行更改。 但是，建议您在Adobe的暂存环境中测试新查看器。 以下网站提供了有关如何设置系统以访问Adobe暂存服务器的说明：
...
* Publish设置未显示Scene7共享Assets公司的颜色配置文件。
* 从FTP上传屏幕：FTP文件夹未排序，但输出是已排序的文件夹列表。
* 更改了Media Portal设置中“编辑组”的“资产访问权限”选项卡的描述。
* 使用Secure Test Image Serving Publish设置时，格式错误的`clientAddressFilter`导致目录服务器出现异常。
