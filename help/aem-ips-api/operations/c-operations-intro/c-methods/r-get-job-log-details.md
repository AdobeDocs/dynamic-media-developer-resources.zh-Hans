...
此 `logMessage` 响应字段基于 `authHeader` `locale` 字段。
...
<table id="table_A77122D73F684B3F8F5AFA1C11C189ED"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> 否 </td> 
   <td colname="col4">最大数量 <span class="codeph"> 详细信息数组</span> 要返回的项目。 最大值和默认值为1000。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> 结果页</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:int</span> </td> 
   <td colname="col3"> 否 </td> 
   <td colname="col4">页码 <span class="codeph"> recordsPerPage</span> — 要返回的结果。 預設值為 1。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> sortby</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> 否 </td> 
   <td colname="col4"> <p>任务详细信息排序字段常量值（Date或LogType）之一。 默认值为Date。 </p> </td> 
  </tr> 
  <tr> 
