...
| ` *`defaultSourceProfileHandle`*` | `xsd:string` | 否 | 用作默认源颜色用户档案的IccProfile资产。 |
...
| ` *`emailTrashCleanupWarning`*` | `xsd:boolean` | 否 | 设置为 `true` 在从垃圾桶中清空资源时向公司管理员发送通知。 |
