...
While `searchAssetsByMetadata` 允许您针对用户定义的元数据字段进行搜索，如果在 `responseMetadataArray`. 为了说明这一点，请参见以下代码示例：
...
要解决此问题，您可以使用 `fieldHandles` 从搜索返回以运行的资产的 `getAssets` (另请参阅 [getAssets](../../../operations/c-operations-intro/c-methods/r-get-assets.md#reference-adad4f504f684d3dabc09e093b8511ca))。 此方法将获取相关资产的用户定义字段值。 使用以下语法示例搜索用户定义的元数据字段：
...
<table id="table_8FF228D6279241849F3D9E5BA080580C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col4"> <p>可帮助您定义搜索条件的过滤器。 </p> <p>请参阅 <a href="../../../types/c-data-types/r-search-filter.md#reference-0e2eb87bccae4b69be6717267bcb80aa" format="dita" scope="local"> SearchFilter</a>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>否 </p> </td> 
   <td colname="col4"> <p>定义搜索条件的条件。 请参阅下文以了解其他信息。 </p> </td> 
  </tr> 
  <tr> 
...
* `modified_at`
* `modified_by`
* `created_at` (与 `modified_at` (表单中的日期：星期五2014年7月25日22:13:45 GMT-0500(CDT)

* `created_by`

**允许的运算符**

的 [!DNL operator] 定义如何比较值，包括：
