...
# Dynamic Media 图像生产系统 API {#image-production-api}
...
+ 操作方法{#operation-methods}
   ...
   + 操作参数{#operation-parameters}
      ...
      + [emptyAssetsFromTrashe](operations/c-operations-intro/c-methods/r-empty-assets-from-trash.md)
      ...
      + [getAssetations](operations/c-operations-intro/c-methods/r-get-associated-assets.md)
      ...
      + [restoreAssetsFromTrashe](operations/c-operations-intro/c-methods/r-restore-assets-from-trash.md)
...
+ 字符串常量{#sting-constants}
   ...
   + [Photoshop层命名模式](string-constants/c-string-constants/r-photoshop-layer-naming-modes.md)
...
+ 更改日志{#change-log}
   ...
   + 版本4.0 {#version-4-0}
      ...
      + [新增内容和更改](change-log/c-change-log/c-4-0/r-4-0-new.md)
   + 版本3.8 {#version-3-8}
