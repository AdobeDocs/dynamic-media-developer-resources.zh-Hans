...
+ 操作方法 {#operation-methods}
   ...
   + 操作引數 {#operation-parameters}
      ...
      + [batchSetIccProfileField](operations/c-operations-intro/c-methods/r-batch-set-icc-profile-fields.md)
      ...
      + [update屬性Set](operations/c-operations-intro/c-methods/r-update-property-set.md)
...
+ 資料型別 {#data-types}
   ...
   + [作用中工作](types/c-data-types/r-active-job.md)
   ...
   + [自動設定建立選項](types/c-data-types/r-auto-set-creation-options.md)
   ...
   + [磁碟使用量](types/c-data-types/r-disk-usage.md)
   + [DiskUseArray](types/c-data-types/r-disk-usage-array.md)
   ...
   + [字型欄位更新陣列](types/c-data-types/r-font-field-update-array.md)
   ...
   + [影像整合員](types/c-data-types/r-image-set-member.md)
   ...
   + [工作記錄詳細資訊](types/c-data-types/r-job-log-detail.md)
   ...
   + [圖層檢視資訊](types/c-data-types/r-layer-view-info.md)
   ...
   + [OptimizeImages作業](types/c-data-types/r-optimize-images-job.md)
   ...
   + [四軸透視](types/c-data-types/r-perspective-quad.md)
   ...
   + [UploadDirectory作業](types/c-data-types/r-upload-directory-job.md)
...
+ 字串常數 {#sting-constants}
   ...
   + [搜尋相符模式](string-constants/c-string-constants/r-search-match-modes.md)
...
+ 變更記錄 {#change-log}
   ...
   + 6.0版 {#version-6-0}
      ...
      + [作業：新增與修改](change-log/c-change-log/c-6/r-6-operations.md)
      + [資料型別：新增和修改](change-log/c-change-log/c-6/r-6-types.md)
   + 版本4.5 {#version-4-5}
      + [4.5 版](change-log/c-change-log/c-4-5/c-4-5.md)
      + [作業：新增與修改](change-log/c-change-log/c-4-5/r-4-5-operations.md)
   ...
   + 版本4.4 {#version-4-4}
      ...
      + [作業：新增與修改](change-log/c-change-log/c-4-4/r-4-4-operations.md)
   ...
   + 版本3.8 {#version-3-8}
      ...
      + [作業：新增與修改](change-log/c-change-log/c-3-8/r-3-8-operations.md)
   ...
   + 版本3.7 {#version-3-7}
      ...
      + [作業：新增與修改](change-log/c-change-log/c-3-7/r-3-7-operations.md)
