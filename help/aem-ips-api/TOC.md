...
user-guide-title: 动态媒体图像生产系统 API
feature-set: Experience Manager Assets
user-guide-description: IPS（映像生产系统）Web服务API使外部应用程序和第三方开发人员能以编程方式访问IPS资源和功能。
...
# 动态媒体图像生产系统 API {#image-production-api}
...
+ 数据类型{#data-types}
   ...
   + [资源](types/c-data-types/r-asset.md)
   ...
   + [资产元数据字段](types/c-data-types/r-asset-metadata-fields.md)
   ...
   + [ExcludeBybsuleArray](types/c-data-types/r-exclude-byproduct-array.md)
   ...
   + [Illustrator选项](types/c-data-types/r-illustrator-options.md)
   ...
   + [Javascript信息](types/c-data-types/r-javascriptinfo.md)
   ...
   + [优化图像作业](types/c-data-types/r-optimize-images-job.md)
   ...
   + [透视四](types/c-data-types/r-perspective-quad.md)
   ...
   + [USMsharpMaskOptions](types/c-data-types/r-unsharp-mask-options.md)
...
+ 字符串常量{#sting-constants}
   ...
   + [资产覆盖模式](string-constants/c-string-constants/r-asset-overwrite-modes.md)
   ...
   + [自动裁剪角](string-constants/c-string-constants/r-auto-crop-corner.md)
   ...
   + [数值/日期比较运算符](string-constants/c-string-constants/r-numeric-date-comparison-operators.md)
   ...
   + [用户档案类](string-constants/c-string-constants/r-profile-classes.md)
   ...
   + [用户字符筛选器字段](string-constants/c-string-constants/r-user-char-filter-fields.md)
...
+ 更改日志{#change-log}
   ...
   + 版本6.0 {#version-6-0}
      ...
      + [数据类型：新建和修改](change-log/c-change-log/c-6/r-6-types.md)
   + 版本4.5 {#version-4-5}
      + [4.5版](change-log/c-change-log/c-4-5/c-4-5.md)
      + [操作：新建和修改](change-log/c-change-log/c-4-5/r-4-5-operations.md)
      + [数据类型：新建和修改](change-log/c-change-log/c-4-5/r-4-5-types.md)
   ...
   + 版本4.4 {#version-4-4}
      ...
      + [数据类型：新建和修改](change-log/c-change-log/c-4-4/r-4-4-types.md)
      + [字符串常量：新建和修改](change-log/c-change-log/c-4-4/r-4-4-string-constants.md)
   + 版本4.2 {#version-4-2}
      + [版本4.2](change-log/c-change-log/c-4-2/c-4-2.md)
      + [数据类型：新建和修改](change-log/c-change-log/c-4-2/r-4-2-types.md)
   + 版本4.0 {#version-4-0}
   ...
   + 版本3.8 {#version-3-8}
      ...
      + [数据类型：新建和修改](change-log/c-change-log/c-3-8/r-3-8-types.md)
      + [字符串常量：新建和修改](change-log/c-change-log/c-3-8/r-3-8-string-constants.md)
   + 版本3.7 {#version-3-7}
      + [版本3.7](change-log/c-change-log/c-3-7/c-3-7.md)
      + [操作：新建和修改](change-log/c-change-log/c-3-7/r-3-7-operations.md)
      + [数据类型：新建和修改](change-log/c-change-log/c-3-7/r-3-7-types.md)
      + [字符串常量：新建和修改](change-log/c-change-log/c-3-7/r-3-7-string-constants.md)
+ [通过HTTP POST将资产上传到UploadFile...](c-http-post.md)
