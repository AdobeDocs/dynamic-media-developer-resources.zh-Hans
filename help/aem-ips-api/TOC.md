...
+ 操作方法 {#operation-methods}
   ...
   + 操作参数 {#operation-parameters}
      ...
      + [创建资产集](operations/c-operations-intro/c-methods/r-create-asset-set.md)
      ...
      + [getOriginalFilePath](operations/c-operations-intro/c-methods/r-get-original-file-paths.md)
...
+ 数据类型 {#data-types}
   ...
   + [磁盘使用量阵列](types/c-data-types/r-disk-usage-array.md)
   ...
   + [图像集成员](types/c-data-types/r-image-set-member.md)
   ...
   + [去底色背景选项](types/c-data-types/r-knockout-background-options.md)
   ...
   + [透视四色](types/c-data-types/r-perspective-quad.md)
   ...
   + [发布历史记录](types/c-data-types/r-publish-history.md)
   ...
   + [SchedulejobArray](types/c-data-types/r-scheduled-job-array.md)
   ...
   + [UploadPost作业](types/c-data-types/r-upload-post-job.md)
...
+ 字符串常量 {#sting-constants}
   ...
   + [资源排序字段](string-constants/c-string-constants/r-asset-sort-fields.md)
   + [资源类型](string-constants/c-string-constants/r-asset-types.md)
   + [自动裁切转角](string-constants/c-string-constants/r-auto-crop-corner.md)
   ...
   + [Illustrator进程](string-constants/c-string-constants/r-illustrator-processes.md)
   ...
   + [PostScript色彩空间模式](string-constants/c-string-constants/r-postscript-colorspace-modes.md)
