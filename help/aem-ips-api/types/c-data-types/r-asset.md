...
<table id="table_C58EF9963CB34179A9D6C9F0F6FF24F2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> 文字：字体信息</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> 类型：图像信息</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> 类型：图层视图信息</span> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">支持子类型值的通用资源子类型(例如， <span class="codeph"> 资产集</span>)。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3">资源类型. 参见 <a href="../../string-constants/c-string-constants/r-asset-types.md#reference-2fe75d230663419d88632d30f1144a10" format="dita" scope="local"> 资源类型</a> 值。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> 类型：查看器预设信息</span> </td> 
   <td colname="col3"> 查看器预设资产的属性。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> [!DNL viewerSwfInfo]</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> 类型：查看器SwfInfo</span> </td> 
   <td colname="col3"> 查看器软件资源的属性。 </td> 
  </tr> 
  <tr> 
