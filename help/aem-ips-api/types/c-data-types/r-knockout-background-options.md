...
<table id="table_68131DE0A3C84908A43C6F7777F20973"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3">选择要使用的拐角。 <span class="codeph">角</span>接受以下值： <ul id="ul_36C2F07706764A7081010D5521BF3096">
  ...
  <tr> 
   ...
   <td colname="col3">一个可选设置，用于根据透明度从图像边缘中去除空格。 接受从0.0到1.0的值的范围。 指定： <ul id="ul_FE5423B857AE43FCBA7A9AEA76C754CC">
