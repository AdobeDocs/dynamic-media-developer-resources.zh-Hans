...
description: 对选定图像的背景进行蒙版（敲除）。 此数据类型允许您在主题图像外具有透明度的其他图层中叠加它们。 默认关闭的可选参数。
...
对选定图像的背景进行蒙版（敲除）。 此数据类型允许您在主题图像外部以透明度将其叠加到其他图层中。
...
>[!IMPORTANT]
>
>如果要配置 `KnockoutBackgroundOptions` 在Adobe Experience Manager中，请改用以下参数：
>* `kbCorner`
>* `kbTolerance`
>* `kbFillMethod`
>
>示例: `KnockoutBackgroundOptions=kbCorner=UpperLeft&kbTolerance=0.2&kbFillMethod=MatchPixel`
...
<table id="table_68131DE0A3C84908A43C6F7777F20973"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3">选择要处理的角。 <span class="codeph"> 角</span> 接受以下值： 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:string</span> </td> 
   <td colname="col3"> <p>在由 <span class="codeph"><span class="varname"> 角</span></span> 变量。 的 <span class="codeph"> fillMethod</span> 接受以下值： </p> 
...
的 `KnockoutBackgroundOptions` 类型的使用者：
