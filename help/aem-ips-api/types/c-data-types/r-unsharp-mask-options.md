...
为选项指定一个 `unsharpMaskOptions` 值( `minOccurs=" *`n)`*".`
...
<table id="table_D1392963C5694969A9D546F82DB6F45C">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colname="col3"><p>确定在将不同像素视为边缘像素并可以锐化之前，它们必须与周围区域的不同像素。 
  ...
  <tr>
   ...
   <td colname="col2"><span class="codeph"> xsd:int</span></td>
   <td colname="col3"><p>值仅包 <span class="codeph"> 括</span> 0或 <span class="codeph"> 1</span> 。 </p><p>设置为 <span class="codeph"> 0</span> ，分别应用于每个颜色组件，设置为 <span class="codeph"> 1</span> ，仅应用于图像亮度（强度）。 图层蒙版或复合蒙版也会被锐化。 </p><p><span class="codeph"><span class="varname"> 灰度图</span></span> 像将忽略monochrome。 </p></td>
  </tr>
 </tbody>
</table>
...
>[!MORELIKETHIS]
>
>* [图像服务API参考：op_usm](https://marketing.adobe.com/resources/help/en_US/s7/is_ir_api/is_api/http_ref/r_op_usm.html)
