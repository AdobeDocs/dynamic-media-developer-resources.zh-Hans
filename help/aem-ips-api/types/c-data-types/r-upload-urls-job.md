...
<table id="table_04100BB8ABD84EF68B0A7CE3AD946414"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> 要应用于上载文件的自动生成集脚本数组。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> 可在上载期间指定的选项。 该集会影响如何为上传管理颜色。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3">蒙版所选图像的背景。 这样，您就可以使用主题图像以外的透明度，将其叠加到其他图层中。 可选. 参见<a href="../../types/c-data-types/r-knockout-background-options.md#reference-9196371848964d91842b337640791c9c" format="dita" scope="local"> 去底色背景选项</a>. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3">允许您从视频设置缩略图图像的选项。 参见 <a href="../../types/c-data-types/r-media-options.md#reference-18618fc6803a4b6e994bbb48eba93b5b" format="dita" scope="local"> 媒体选项</a>. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> 文件是否标记为可发布。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> uncompressOptions</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> 类型：UnCompressOptions</span> </td> 
   <td colname="col3">使用这些可选设置提取并处理上传的TAR/ZIP文件的内容。 参见 <a href="../../types/c-data-types/r-uncompress-options.md#reference-510ec7028b1540bc9b58745f242d49d5" format="dita" scope="local"> UnCompressOptions</a>. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> <span class="varname"> unsharpMaskOptions</span> </span> </td> 
   <td colname="col2"> <span class="codeph"> 类型：USM选项</span> </td> 
   <td colname="col3">允许您在创建优化的金字塔TIF文件时控制钝化蒙版设置的选项。 使用这些设置有助于提高图像清晰度。 参见 <a href="../../types/c-data-types/r-unsharp-mask-options.md#reference-b9a96244d7ee4424bc4ac3c23be3be3d" format="dita" scope="local"> UnsharpMaskOptions</a>. </td> 
  </tr> 
  <tr> 
