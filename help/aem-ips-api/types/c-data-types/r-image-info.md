...
<table id="table_04100BB8ABD84EF68B0A7CE3AD946414"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd：string</span> </td> 
   <td colname="col3"> <p>IPS优化图像文件。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd：int</span> </td> 
   <td colname="col3"> <p>以像素为单位的水平锚点。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> xsd：string</span> </td> 
   <td colname="col3"> <p>连接至<span class="codeph"> urlModifier</span>末尾的参数。 查询字符串格式作为图像服务器命令的参数列表。 值位于图像服务器协议指南中。 </p> </td> 
  </tr> 
  <tr> 
