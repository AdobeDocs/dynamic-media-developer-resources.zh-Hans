...
<table id="table_57CEE262A33A4E898C6AFB30C93FD874"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <span class="codeph"> type:StringArray</span> </td> 
   <td colname="col3">要在搜索中返回的资产子类型列表。 例如，对于 <span class="codeph"> 资产集</span>，您可以搜索 <span class="codeph"> MediaType</span> 子类型。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"><span class="codeph"><span class="varname"> strictSubTypeCheck</span></span> </td> 
   <td colname="col2"><span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> <p>可选布尔标记，用于指定在 <span class="codeph"> assetSubTypeArray</span> 已通过。 </p> <p>如果为true，则只返回具有其中一个指定子类型的资产。 </p> <p>如果为false，则还会返回没有子类型的资产。 </p> <p>默认值为false。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3">指定: 
    ...
    </ul> <p>注意：留空以搜索 <i>全部</i> 已发布的状态类型。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3">指定: 
    <ul id="ul_D31B903FA8DA4CFFABAFABA3D8DA91EC"> 
     <li id="li_E4386C8260E64F0BAFE5BA57FF788E48"><span class="codeph"> 任意</span> 返回资产，而不考虑其垃圾桶状态。 </li> 
     <li id="li_0B8933FE18C643828075EC8CE8C0223C"><span class="codeph"> NotInTrash</span> 返回“正常”资产。 </li> 
     <li id="li_A1F46A0762FA4D4BA9F7247338238DC6"><span class="codeph"> InTrash</span> 从垃圾桶返回资产。 </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
