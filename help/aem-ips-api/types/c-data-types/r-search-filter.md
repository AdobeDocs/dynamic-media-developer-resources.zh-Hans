...
<table id="table_57CEE262A33A4E898C6AFB30C93FD874"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> 指定要搜索的文件夹。 留空即可搜索整个公司。 </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3">设置为： 
    <ul id="ul_BD8686943BD14D05A21C00192D4D70D3"> 
     <li id="li_B6A6DE5AAEFF4A80A8413B4785A88222"><span class="codeph"> 真</span>:要搜索已命名的文件夹和所有子文件夹，请执行以下操作： </li> 
     <li id="li_10A581F98B4847ED8EBE4AECC3AD70A8"><span class="codeph"> 错误</span>:仅搜索命名文件夹。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"><span class="codeph"> xsd:boolean</span> </td> 
   <td colname="col3"> <p>一个可选的布尔标志，它指定在传递<span class="codeph"> assetSubTypeArray</span>时是否返回没有子类型的资产。 </p> <p>如果为true，则只返回具有某个指定子类型的资产。 </p> <p>如果为false，则还会返回没有子类型的资产。 </p> <p>默认值为false。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3">指定: 
    <ul id="ul_D31B903FA8DA4CFFABAFABA3D8DA91EC"> 
     <li id="li_E4386C8260E64F0BAFE5BA57FF788E48"><span class="codeph"> 无</span> 论资源的垃圾状态如何，都可以返回资源。 </li> 
     <li id="li_0B8933FE18C643828075EC8CE8C0223C"><span class="codeph"> NotInTrash</span> 返回“正常”资产。 </li> 
     <li id="li_A1F46A0762FA4D4BA9F7247338238DC6"><span class="codeph"> InTrash</span> 从垃圾桶返回资源。 </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
