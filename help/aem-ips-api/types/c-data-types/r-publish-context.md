...
资产会为每个发布状态和上下文保留一个单独的标记。 使用setAssetsContextState设置发 [布状态](../../operations/c-operations-intro/c-methods/r-set-asset-context-state.md#reference-da96f9caef734f2883fddaf58cd886d7)。
